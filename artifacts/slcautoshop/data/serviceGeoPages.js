...
const CITIES = [
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Sugar House with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Sugar House so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Sugar House", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      ...
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    slug: 'millcreek', name: 'Millcreek', distance: '3 miles', driveTime: '7 min',
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Millcreek with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Millcreek so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Millcreek", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Murray with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Murray so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Murray", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Salt Lake City with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Salt Lake City so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Salt Lake City", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Taylorsville with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Taylorsville so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Taylorsville", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from West Valley City with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from West Valley City so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from West Valley City", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Holladay with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Holladay so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Holladay", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Cottonwood Heights with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Cottonwood Heights so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Cottonwood Heights", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Sandy with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Sandy so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Sandy", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Draper with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Draper so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Draper", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from West Jordan with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from West Jordan so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from West Jordan", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from South Jordan with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from South Jordan so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from South Jordan", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Riverton with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Riverton so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Riverton", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Herriman with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Herriman so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Herriman", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Kearns with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Kearns so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Kearns", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
  },
  {
    ...
    directions: "Our shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions to plan your trip from Midvale with current traffic and your exact starting point.",
    landmarks: [],
    logisticsNote: "Before dropping off your vehicle, call to confirm an appointment and the expected inspection time. If you need a ride home or to work, arrange it before your visit. Check current transit routes or rideshare availability for the shop address.",
    processNote: "Call before coming from Midvale so we can discuss your vehicle, arrange drop-off, and estimate how long the inspection or repair may take.",
    whyChooseUs: [
      { title: "Plan Your Visit from Midvale", desc: "Use the map link for directions to our South Salt Lake shop. Confirm your appointment and arrange a ride if you need to leave the vehicle." },
      { title: "Tell Us When the Problem Happens", desc: "Tell us whether the noise, vibration, or warning light appears during acceleration, braking, turning, or idling. Those details help us reproduce the problem during the inspection." },
      { title: 'Diagnosis Before We Recommend Anything', desc: 'We check the whole system before pointing to any specific part. You know exactly what we found and why before any work begins.' },
      { title: 'In Business Since 1990', desc: "Scott's Auto & Clutch Repair has operated in South Salt Lake since 1990. We explain the inspection findings and discuss the repair before you approve the work." }
    ]
...
const CONTENT = {
  ...
  'water-pump-replacement': {
    ...
    cities: {
      'sugar-house': {
        ...
        localTip: "A startup squeal can come from a belt, tensioner, pulley, or another rotating component. Have the sound located before replacing the water pump. Stop safely if the engine overheats.",
      ...
      'murray': {
        ...
        localContent: "An engine that runs hot in slow traffic needs a cooling-system inspection. Reduced airflow at low speed can reveal fan or airflow problems, but coolant loss and circulation faults also need checking. Tell us whether the temperature rises at idle, on hills, or at a steady road speed; that pattern guides the inspection without identifying one part by itself.",
        localTip: "Overheating in slow traffic can involve fan operation, coolant level, restricted airflow, or other cooling-system faults. The temperature pattern alone does not identify the water pump or rule out the thermostat. Stop safely if the engine overheats and arrange an inspection.",
  ...
  'complete-auto-service': {
    ...
    cities: {
      ...
      'draper': {
        ...
        localContent: "A maintenance visit is a chance to review what your vehicle needs now and what can wait. Bring your mileage, service records, and any warning-light or noise concerns. We can explain the inspection findings, discuss the recommended work, and give you an estimate before repairs begin.",
        localTip: "Bring your service records or photos of previous invoices. Knowing when fluids, belts, brakes, and other parts were last serviced helps avoid repeating work that is not due.",
      ...
      'midvale': {
        intro: "The shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions for the route from your starting address. If you plan to take transit after drop-off, check the full trip, including the station-to-shop connection, with UTA before your visit.",
        ...
        localTip: "The shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions for the route from your starting address. If you plan to take transit after drop-off, check the full trip, including the station-to-shop connection, with UTA before your visit.",
  ...
  'head-gasket-repair': {
    ...
    cities: {
      ...
      'herriman': {
        ...
        localContent: "Sustained uphill driving and towing can expose a cooling-system problem that is less noticeable under lighter load. Tell us whether overheating happens while climbing, idling, or driving at steady speed, and whether coolant has needed topping up. We check for leaks and other cooling faults before recommending head gasket work.",
      ...
      'kearns': {
        intro: "Kearns drivers with overheating, unexplained coolant loss, or persistent white exhaust smoke should arrange an inspection. Those symptoms can suggest a head gasket problem, but they do not confirm one.",
        localContent: "Head gasket failure can follow overheating, and a failed gasket can also cause overheating. Mileage or the type of roads you drive cannot establish the cause. We check for external leaks and use the appropriate cooling-system and engine tests to investigate before recommending head gasket replacement.",
        localTip: "Use the coolant specification and replacement schedule for your vehicle. Color alone does not identify coolant condition or compatibility. Bring your service records so we can check what was used and when it was replaced.",
        landmarks: [],
        metaTitle: 'Head Gasket Repair Near Kearns UT | Scott\'s Auto',
        metaDesc: "Head gasket diagnosis and repair for Kearns drivers. We investigate overheating and coolant loss at our South Salt Lake shop. Call (801) 485-4089."
      },
      'midvale': {
        intro: "Midvale drivers concerned about a head gasket can arrange an inspection at our South Salt Lake shop. Coolant loss and overheating have several possible causes; we check the cooling system before recommending engine disassembly.",
        localContent: "If your engine overheats, loses coolant, or produces persistent white exhaust smoke, arrange an inspection before continuing to drive it. Bring any cooling-system repair records. If the vehicle cannot be driven safely, call to discuss towing and plan a separate ride to or from the shop.",
  ...
  'lift-leveling-kit-installation': {
    ...
    cities: {
      'sugar-house': {
        ...
        localContent: "Before choosing a leveling kit, check tire clearance for your truck, wheel size, offset, and suspension setup. Tire fitment is not guaranteed by tire size or lift height alone. We can discuss how a proposed change affects clearance, alignment, and everyday use before you choose parts.",
      ...
      'salt-lake-city': {
        ...
        localContent: "The shop is at 144 W Crystal Ave, South Salt Lake, UT 84115. Use Get Directions for the route from your starting address. If you plan to take transit after drop-off, check the full trip, including the station-to-shop connection, with UTA before your visit.",
      ...
      'holladay': {
        ...
        localContent: "A leveling kit does not make a vehicle compliant with canyon traction restrictions. Check current road requirements separately from suspension changes. For a truck used in winter, discuss tire suitability, clearance at full steering lock, and the effect of a lift on handling before choosing a kit.",
      ...
      'cottonwood-heights': {
        intro: "Considering a lift or leveling kit for a Cottonwood Heights truck? We can discuss tire clearance, alignment, and how the change fits your driving needs. Canyon traction requirements must be checked separately.",
        localContent: "Lift height and four-wheel drive do not replace the need to check current canyon traction requirements. For a winter-use truck, tire choice, clearance, and vehicle condition deserve attention before suspension changes. Bring your truck details and proposed tire size so we can discuss fitment and handling.",
      ...
      'sandy': {
        ...
        localContent: "Choose a suspension kit for your truck and the roads you actually use. Spacer, strut, and coilover options have different clearance, travel, and alignment considerations. A lift does not grant access to a trail or satisfy winter traction rules; check road access and conditions separately.",
  ...
  "check-engine-light-engine-repair": {
    ...
    "cities": {
      "sugar-house": {
        "intro": "Sugar House drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Sugar House | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Sugar House drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "millcreek": {
        "intro": "Millcreek drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Millcreek | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Millcreek drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "murray": {
        "intro": "Murray drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Murray | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Murray drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "salt-lake-city": {
        "intro": "Salt Lake City drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Salt Lake City | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Salt Lake City drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "taylorsville": {
        "intro": "Taylorsville drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Taylorsville | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Taylorsville drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "west-valley-city": {
        "intro": "West Valley City drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near West Valley City | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for West Valley City drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "holladay": {
        "intro": "Holladay drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Holladay | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Holladay drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "cottonwood-heights": {
        "intro": "Cottonwood Heights drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Cottonwood Heights | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Cottonwood Heights drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "sandy": {
        "intro": "Sandy drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Sandy | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Sandy drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "draper": {
        "intro": "Draper drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Draper | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Draper drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "west-jordan": {
        "intro": "West Jordan drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near West Jordan | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for West Jordan drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "south-jordan": {
        "intro": "South Jordan drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near South Jordan | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for South Jordan drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "riverton": {
        "intro": "Riverton drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Riverton | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Riverton drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "herriman": {
        "intro": "Herriman drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Herriman | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Herriman drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "kearns": {
        "intro": "Kearns drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Kearns | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Kearns drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      },
      "midvale": {
        "intro": "Midvale drivers can bring check engine lights and engine running problems to our South Salt Lake shop. Tell us whether the light is steady or flashing and whether the engine runs roughly, hesitates, or loses power.",
        "localContent": "A trouble code identifies a condition the computer detected; it does not tell us which part to replace. For example, a misfire needs checks of ignition, fuel delivery, and engine condition. We use stored codes, freeze-frame information, and operating data to choose the next inspection. We explain the findings before recommending a repair.",
        "localTip": "Keep any code numbers and recent repair records. Avoid clearing codes before the inspection because it can erase useful diagnostic information. If the light flashes or the engine shakes badly, stop driving and call to discuss the symptoms and towing.",
        "landmarks": [],
        "metaTitle": "Check Engine Light Diagnosis near Midvale | Scott's Auto",
        "metaDesc": "Check engine light diagnosis for Midvale drivers at our South Salt Lake shop. We test before recommending parts. Call (801) 485-4089."
      }
    }
  },
  ...
  "transmission-repair": {
    ...
    "cities": {
      "sugar-house": {
        "intro": "Sugar House drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Sugar House drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "millcreek": {
        "intro": "Millcreek drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Millcreek drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "murray": {
        "intro": "Murray drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Murray drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "salt-lake-city": {
        "intro": "Salt Lake City drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Salt Lake City drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "taylorsville": {
        "intro": "Taylorsville drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Taylorsville drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "west-valley-city": {
        "intro": "West Valley City drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for West Valley City drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "holladay": {
        "intro": "Holladay drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Holladay drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "cottonwood-heights": {
        "intro": "Cottonwood Heights drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Cottonwood Heights drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "sandy": {
        "intro": "Sandy drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Sandy drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "draper": {
        "intro": "Draper drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Draper drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "west-jordan": {
        "intro": "West Jordan drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for West Jordan drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "south-jordan": {
        "intro": "South Jordan drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for South Jordan drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "riverton": {
        "intro": "Riverton drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Riverton drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "herriman": {
        "intro": "Herriman drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Herriman drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "kearns": {
        "intro": "Kearns drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Kearns drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      },
      "midvale": {
        "intro": "Midvale drivers can bring slipping, hard shifts, or delayed movement in Drive or Reverse to our South Salt Lake shop. Tell us your vehicle model and whether it has a manual or automatic transmission.",
        "localContent": "Tell us whether the engine revs without the vehicle accelerating, the shift feels harsh, or the vehicle takes longer to move after you select Drive or Reverse. Also note whether the problem starts cold or after driving. We use that pattern to guide fluid, leak, code, and operating checks. A fluid service is not a guaranteed fix for slipping or internal wear.",
        "localTip": "Bring your service history and tell us about towing or recent transmission work. We use the vehicle manufacturer's fluid specification and service procedure. If the vehicle cannot accelerate reliably or drops out of gear, stop driving and call to discuss towing.",
        "landmarks": [],
        "metaDesc": "Transmission diagnosis for Midvale drivers at our South Salt Lake shop. Slipping, hard shifts, or delayed engagement? Call (801) 485-4089."
      }
    }
  },
...
// Descriptive service titles. Search engines determine displayed title length.
const TITLE_TEMPLATES = {
  ...
  'check-engine-light-engine-repair': "Check Engine Light Diagnosis near {{CITY}} | Scott's Auto",
