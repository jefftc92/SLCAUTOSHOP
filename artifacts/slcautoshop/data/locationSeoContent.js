// Rich SEO content for each location page
// This adds substantial, keyword-dense unique content per city
...
const locationSeoContent = {
  'south-salt-lake-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'CV Axle Repair', context: 'Tight parking lot turns and frequent directional changes in South Salt Lake\'s commercial corridors stress CV joints. Clicking noises during turns mean it\'s time for inspection.' },
  ...
  'sugar-house-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'CV Joint Repair', context: 'Sugar House\'s older streets and tight parking near the business district stress CV joints. Clicking sounds when turning signal a need for inspection.' },
  ...
  'millcreek-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Clutch Repair', context: 'The grades on Wasatch Boulevard and canyon access roads wear clutches faster than flatland driving. Manual transmission drivers in Millcreek should monitor clutch engagement point.' },
  ...
  'taylorsville-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Exhaust Repair', context: 'Taylorsville\'s commercial corridors mean more stop-and-go driving, which accelerates exhaust system wear from thermal cycling.' },
  ...
  'west-valley-city-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'CV Axle Repair', context: 'Tight parking and frequent directional changes in West Valley\'s shopping centers (Valley Fair Mall, West Valley Commons) stress CV joints and boots.' },
  ...
  'holladay-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Cooling System Service', context: 'Mountain driving from Holladay into Big Cottonwood stresses cooling systems. A pressurized cooling system test every 30,000 miles prevents roadside overheating.' },
  ...
  'cottonwood-heights-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Cooling System Service', context: 'Canyon driving from Cottonwood Heights generates sustained heat that stresses cooling systems. Water pump failures and thermostat issues are more common here than flatland areas.' },
  ...
  'draper-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Cooling System Service', context: 'The climb up Point of the Mountain from the valley stresses cooling systems, especially in summer. Coolant leaks and water pump failures show up earlier in Draper vehicles than flatland driving.' },
  ...
  'south-jordan-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Cooling System Service', context: 'South Jordan\'s summer heat combined with freeway commuting stresses cooling systems. Coolant flushes every 60,000 miles prevent water pump failures on long commutes.' },
  ...
  'riverton-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Cooling System Service', context: 'Long commutes and summer heat stress Riverton vehicles. Cooling system issues are one of the more common repairs we see from Riverton customers.' },
  ...
  'herriman-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Suspension Service', context: 'Herriman\'s hillside streets and long freeway commutes combine to stress suspension components. Struts and shocks typically need replacement earlier than average in Herriman vehicles.' },
  ...
  'kearns-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Complete Auto Service', context: 'Kearns\'s diverse community drives a wide range of vehicles that all benefit from our honest, complete auto service approach.' },
  ...
  'midvale-ut-auto-repair': {
    ...
    commonNeeds: [
      ...
      { service: 'Suspension Service', context: 'Midvale\'s older streets and the I-15/I-215 interchange mean rough patches that wear suspension faster than smoother newer roads.' },
...
function getLocationSeoContent(slug) {
  return locationSeoContent[slug] || null;
}

module.exports = { getLocationSeoContent };
