...
const symptomFaqs = {
  'clutch-slipping': [
    {q:'Can I still drive with a slipping clutch?',a:'For now, usually yes — but the window is shrinking. Each slip event generates heat that wears the disc faster, so the rate of wear accelerates. Stop driving and call if slip appears at moderate throttle on flat roads, you smell burning, or RPMs spike dramatically when climbing hills.'},
    {q:'How long does a new clutch last?',a:'A properly installed clutch lasts 60,000–100,000 miles under normal driving. Utah\'s mountain grades and stop-and-go traffic shorten that — drivers who commute through the canyons or up onto the benches often see 50,000–70,000 miles. Towing, hard launches, and riding the clutch shorten clutch life further.'},
    {q:'How does pricing for clutch repair work?',a:'Diagnosis is free. After we inspect the clutch and flywheel, you get a written estimate covering parts, labor, and any related work needed (like a leaking seal). We don\'t start until you approve. Final cost depends on whether the flywheel needs resurfacing or replacement.'},
    {q:'Should I replace the flywheel when I replace the clutch?',a:'Only if needed. We measure flywheel runout and inspect the surface for glazing or heat checks. If it\'s within spec, the clutch kit alone is the complete repair. If it\'s damaged from extended slipping, installing a new disc on it leads to a repeat failure within months.'}
  ],
