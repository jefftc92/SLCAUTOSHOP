const symptoms = [
  {
    ...
    serviceBlurb: "Clutch slipping almost always means the friction disc is past its service life. Our clutch replacement covers the complete assembly—disc, pressure plate, and throw-out bearing as a matched set—plus flywheel inspection and resurfacing if needed. We use OEM-spec or better components because a properly done clutch should last 80,000–100,000 miles under normal driving. We'll also inspect the rear main seal and transmission input shaft seal for oil leaks that could contaminate a new clutch and shorten its life.",
  ...
  },
  {
    ...
    serviceBlurb: "When a clutch is generating enough heat to smell, it's in the late stages of its life. Our clutch replacement service covers the complete assembly—disc, pressure plate, throw-out bearing, and flywheel inspection and resurfacing. We can also check for rear main seal or input shaft leaks while the transmission is out, since oil contamination is a common reason clutches burn out prematurely even before the friction material is fully worn.",
  ...
  },
  {
    ...
    serviceBlurb: "Our CV joint service replaces the worn axle assembly with a remanufactured or OEM-spec unit—including a new boot and fresh grease packed to spec. In most cases, replacing the full axle shaft rather than just rebooting the existing joint delivers a longer-lasting repair at a comparable price. We'll also inspect the opposite axle while your vehicle is on the lift, since if one boot has torn, the other is often aging and close behind.",
  ...
  },
  {
    ...
    serviceBlurb: "Metal-on-metal contact means we'll almost certainly need to replace pads and rotors—the rotor surface will have scoring from the contact that prevents proper pad seating. Our brake replacement service includes new pads, new or resurfaced rotors depending on remaining thickness, caliper slide pin inspection and lubrication, and a brake fluid check. Every brake job is road-tested before the car leaves the shop.",
  ...
  },
  {
    ...
    serviceBlurb: "Timing chain diagnosis involves removing the valve cover to physically inspect chain stretch, tensioner condition, and guide wear. If the chain has already jumped, we use a scan tool to check cam-to-crank correlation before disassembly so we understand the full extent of the problem. Our timing chain service replaces the chain, tensioner, and guides as a complete job—along with cam and crank seals while everything is accessible—because replacing only the chain on a worn tensioner leads to the problem recurring.",
  ...
  },
  {
    ...
    serviceBlurb: "Strut replacement is done in pairs—both fronts or both rears—to maintain even handling characteristics and prevent pulling to one side. Our strut service includes complete strut assemblies, new strut mounts and spring seats, and a four-wheel alignment after installation, because new struts change the suspension geometry and alignment must be reset to spec. We'll inspect the opposing pair while we're working so you know their condition and can make an informed decision about replacing them.",
  ...
  },
  {
    ...
    serviceBlurb: "Front strut replacement restores the vehicle's ability to resist weight transfer under braking. We use complete strut assemblies—strut, spring, and top mount together—which ensures the mount bearing is new and eliminates the need to compress springs on the old strut. A four-wheel alignment is always included after strut replacement because suspension geometry changes with new components, and driving on misaligned geometry accelerates tire wear.",
