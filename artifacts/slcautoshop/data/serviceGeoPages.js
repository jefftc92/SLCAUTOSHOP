...
const CONTENT = {
  ...
  'head-gasket-repair': {
    ...
    cities: {
      'sugar-house': {
        ...
        landmarks: [
          { name: 'Westminster University Hill — 1300 E & Sugarmont Dr', distance: '3 min northeast of shop', tip: 'One of Sugar House\'s steepest sustained residential grades. Uphill stop-and-go on this hill in summer — A/C running, engine fully warm — is the classic condition where a marginal head gasket first shows as a climbing temperature gauge before it shows anywhere else.' },
          { name: 'Fairmont Park — 900 E & 2700 S', distance: '2 min south of shop', tip: 'A recognizable south Sugar House landmark. From Fairmont, head west on 2700 South then south on State Street — Crystal Ave is about 1.5 miles ahead on the left. Our shop is at 144 W Crystal Ave.' },
          { name: '2700 South & State Street', distance: '1 min from shop', tip: 'The main junction just south of Sugar House on the route to our shop. From 2700 South, head west on Crystal Ave — we\'re halfway down the block on the right at 144 W Crystal Ave.' }
        ],
      ...
      'millcreek': {
        ...
        landmarks: [
          { name: 'Big Cottonwood Rd at 6200 South — Uphill Approach Grade', distance: '5 min east of shop', tip: 'The sustained uphill section of Big Cottonwood Road before the official canyon entrance. Vehicles with marginal cooling systems often show temperature spikes on this approach grade before reaching the canyon — a warning signal that flat-valley driving never produces.' },
          { name: 'Murray Central TRAX Station — Red Line', distance: '3 miles south of shop', tip: 'The nearest Red Line station for Millcreek customers whose vehicle can\'t safely be driven. Board here heading north — Central Pointe is one stop away, then a 3-minute walk east to our shop at 144 W Crystal Ave. Repairs over $1,000 include free towing.' },
          { name: '3900 South & Highland Drive', distance: '2 min from shop', tip: 'The southern Millcreek landmark on the Highland Drive route to our shop. Head north on Highland Drive from 3900 South — Crystal Ave is about 2 minutes ahead on the left at 144 W Crystal Ave.' }
        ],
      ...
      'murray': {
        ...
        landmarks: [
          { name: 'State Street & 6200 South — Dense Signal Zone', distance: '3 miles south of shop', tip: 'The most signal-dense section of Murray\'s State Street corridor. Summer stop-and-go at this intersection — A/C on, engine fully warm — is the driving pattern most likely to reveal a cooling system operating at its thermal limit before a temperature gauge climbs noticeably.' },
          { name: 'Murray Central TRAX Station — Red Line', distance: '4 miles south of shop', tip: 'The main Red Line station for Murray customers whose vehicle can\'t safely be driven. Board here and ride north to Central Pointe Station — a 3-minute walk east to our shop at 144 W Crystal Ave. If your car is overheating, call first before driving.' },
          { name: '4800 South & State Street', distance: '2 miles south of shop', tip: 'The northern Murray corridor on the State Street route to our shop. From 4800 South heading north on State Street, our shop is about 1.5 miles ahead — turn left on Crystal Ave, we\'re halfway down the block.' }
        ],
      ...
      'salt-lake-city': {
        ...
        landmarks: [
          { name: 'Virginia Street Grade — Avenues Residential Climb', distance: '4 min northeast of shop', tip: 'The steepest sustained grade in the Avenues — a daily climb for many SLC residents. Uphill A/C-on driving in summer is the highest head gasket stress condition, and Virginia Street\'s grade is where a marginal cooling system first shows a climbing temperature gauge before any flat-ground symptom appears.' },
          { name: 'University of Utah TRAX Hub — Red/Blue Line', distance: '5 min northeast of shop', tip: 'For SLC customers whose vehicle can\'t be driven safely. Board the Red Line heading west from the University Medical Center stop and ride to Central Pointe Station — a 3-minute walk to our shop. Repairs over $1,000 include free towing.' },
          { name: '2100 South & State Street', distance: '1 min from shop', tip: 'The main SLC arterial on the direct route to our shop. From 2100 South, head west on Crystal Ave — we\'re halfway down the block on the right at 144 W Crystal Ave.' }
        ],
      ...
      'taylorsville': {
        ...
        landmarks: [
          { name: '4700 South & Redwood Road — High-Traffic Intersection', distance: '4 min west of shop', tip: 'The busiest stop-and-go intersection in Taylorsville. Summer idling here — engine at temperature, A/C on full — is the flat-ground condition most likely to reveal a cooling system approaching its limit. A temperature gauge that climbs at this intersection and settles at highway speed is a classic early head gasket symptom.' },
          { name: 'Meadowbrook TRAX Station — Red Line', distance: '5 min northwest of shop', tip: 'The most convenient transit option for Taylorsville customers whose vehicle can\'t be safely driven. Board the Red Line here and ride north to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave. Call before driving an overheating vehicle.' },
          { name: '5400 South & Redwood Road', distance: '3 min south of shop', tip: 'A useful landmark from central Taylorsville. From here, head north on Redwood Road to 4700 South, then east to State Street, then north — Crystal Ave is about 2.5 miles ahead on the left.' }
        ],
      ...
      'west-valley-city': {
        ...
        landmarks: [
          { name: '3500 South & 5600 West — Western Commercial Zone', distance: '6 min west of shop', tip: 'The far-west West Valley commercial corridor where work trucks and hauling vehicles spend much of the day. High-mileage vehicles in sustained commercial operation on this strip in summer — engines under load at ambient temperatures above 95°F — show cooling system weakness faster than passenger cars in the same conditions.' },
          { name: 'West Valley TRAX Station — Red Line', distance: '5 min west of shop', tip: 'The nearest Red Line station for West Valley City customers whose vehicle can\'t be safely driven. Board here heading east — ride to Central Pointe Station, then a 3-minute walk east to our shop at 144 W Crystal Ave.' },
          { name: 'I-215 & 3500 South Interchange', distance: '4 min east of shop', tip: 'The main freeway junction for West Valley City to our shop. Head east on I-215 from the 3500 South on-ramp — take the 2100 South exit, head east on 2100 South, and turn right on Crystal Ave.' }
        ],
      ...
      'holladay': {
        ...
        landmarks: [
          { name: 'Holladay Boulevard & 4500 South — Residential Grade Entry', distance: '5 min east of shop', tip: 'The main residential arterial for central Holladay, where daily uphill returns from the valley cycle cooling systems through repeated heat-up patterns. Vehicles that run slightly warm on the uphill return often have the same root cause as those that overheat on Big Cottonwood Canyon grades — a marginal thermostat, slow water pump, or weakened gasket sealing.' },
          { name: 'Fort Union Boulevard & 1300 East', distance: '4 min east of shop', tip: 'Eastern Holladay landmark near the Big Cottonwood Canyon approach route. From here, head west on Fort Union to Highland Drive and north toward our shop — Crystal Ave is about 4 minutes ahead on the left.' },
          { name: 'Big Cottonwood Canyon Approach — Wasatch Blvd at 6200 S', distance: '6 min east of shop', tip: 'The canyon approach grade before the official entrance — where Holladay cooling systems first encounter sustained high-load climbing. Temperature gauge behavior on this approach is often the first indicator of a cooling system failure that hasn\'t yet appeared in flat-valley driving.' }
        ],
      ...
      'cottonwood-heights': {
        ...
        landmarks: [
          { name: 'Little Cottonwood Canyon Rd — Below the Entrance', distance: '5 min east', tip: 'The sustained approach grade before the canyon checkpoint — where cold-start climbing in sub-zero temperatures puts the highest thermal shock on head gasket sealing surfaces. Cottonwood Heights vehicles used for early morning ski runs regularly encounter this exact stress pattern, which is why cooling system failures from this area skew toward ski season.' },
          { name: 'Fort Union Boulevard & 2300 East', distance: '3 min east of shop', tip: 'Eastern Cottonwood Heights landmark near the Big Cottonwood Canyon access route. From here, head west on Fort Union to Highland Drive, then north to Crystal Ave — about 3 minutes from our shop at 144 W Crystal Ave.' },
          { name: '6200 South & Highland Drive — Valley Grade Entry', distance: '3 min from shop', tip: 'The point where the southbound drive begins rising toward Holladay and the foothills. Vehicles running this route daily with a marginal cooling system sometimes first notice a temperature gauge creeping higher than usual on this gentle uphill in peak summer heat.' }
        ],
      ...
      'sandy': {
        ...
        landmarks: [
          { name: 'Bell Canyon Access Road — Eastern Sandy Foothills', distance: '8 min east', tip: 'The steep foothill access road climbing toward Bell Canyon at 4,700–5,000 feet. This grade at high ambient temperature — common in July and August — is where Sandy vehicles with marginal cooling systems first overheat. A temperature gauge that climbed on Bell Canyon Road and settled after turning around is a cooling system that needs inspection now.' },
          { name: 'Sandy Expo Center TRAX Station — Blue Line', distance: '8 miles south of shop', tip: 'An alternate Blue Line station for Sandy customers whose vehicle can\'t safely be driven. Board here heading north and ride to Central Pointe Station — 3 minutes from our shop. Repairs over $1,000 include free towing if driving isn\'t safe.' },
          { name: '10000 South & State Street', distance: '5 miles south of shop', tip: 'The northern Sandy commercial arterial on the State Street route to our shop. From here, head north on State Street — our shop is about 4 miles ahead. Turn left on Crystal Ave just past the 2700 South light.' }
        ],
      ...
      'draper': {
        ...
        landmarks: [
          { name: 'SunCrest Drive — Upper Draper Elevation Access', distance: '8 min southeast', tip: 'The winding hillside road into SunCrest\'s 5,200-foot neighborhoods. Sustained uphill climbing at high elevation with A/C on in summer compresses the thermal margin between normal operating temperature and overheating — SunCrest access roads are where Draper cooling systems encounter conditions that valley-floor driving never produces.' },
          { name: 'Draper Town Center TRAX Station — Blue Line', distance: '12 miles south of shop', tip: 'The nearest Blue Line station for Draper customers whose vehicle can\'t safely be driven. Board here heading north and ride to Central Pointe Station — 3 minutes east on foot to our shop. Repairs over $1,000 include free towing.' },
          { name: 'I-15 & 12300 South — Draper Freeway Entry', distance: '10 miles south of shop', tip: 'The main freeway starting point from Draper toward our shop. Head north on I-15 from here — about 10 miles to the 2700 South exit in South Salt Lake, then east about a mile to Crystal Ave.' }
        ],
      ...
      'west-jordan': {
        ...
        landmarks: [
          { name: 'Mountain View Corridor & 7000 South — Sustained-Speed Zone', distance: '5 miles south of shop', tip: 'The high-speed segment of Mountain View Corridor where West Jordan vehicles maintain freeway speeds on a hot road surface in summer. High-mileage cooling systems that hold up at residential speeds often show their weakness on sustained highway runs in 95°F heat — this corridor is where West Jordan drivers first notice a temperature gauge running higher than usual.' },
          { name: 'Jordan Valley Hospital — 3580 W 9000 S', distance: '5 min west of shop area', tip: 'A well-known West Jordan landmark near the 9000 South corridor. From Jordan Valley Hospital, head east on 9000 South to Redwood Road, then north to I-15, then north to the 2700 South exit — about 8 miles to our shop at 144 W Crystal Ave.' },
          { name: '7800 South & State Street', distance: '4 miles south of shop', tip: 'An alternate route from West Jordan. Head north on State Street from 7800 South — our shop is about 3.5 miles ahead. Turn left on Crystal Ave just past the 2700 South light.' }
        ],
      ...
      'south-jordan': {
        ...
        landmarks: [
          { name: 'Bangerter Highway Grade — 11400 South Area', distance: '10 min south', tip: 'The elevated grade-separated section of Bangerter Highway that South Jordan vehicles climb daily. In summer with A/C running and a full passenger load, this grade reveals marginal cooling capacity faster than flat Daybreak street driving — a temperature gauge that climbs on Bangerter and settles in the neighborhood is worth diagnosing promptly.' },
          { name: 'South Jordan Parkway TRAX Station — Blue Line', distance: '10 miles south of shop', tip: 'The Blue Line station for South Jordan customers whose vehicle can\'t be safely driven. Board here heading north and ride to Central Pointe Station — 3 minutes east on foot to our shop. Free towing applies to qualifying repairs.' },
          { name: '11400 South & State Street', distance: '8 miles south of shop', tip: 'A major south valley arterial on the route north to our shop. From here, head north on State Street for about 8 miles — Crystal Ave will be on your left just past the 2700 South light at 144 W Crystal Ave.' }
        ],
      ...
      'riverton': {
        ...
        landmarks: [
          { name: 'Bangerter Highway & 12600 South — Main Riverton Corridor', distance: '12 min south', tip: 'The main Riverton arterial on Bangerter Highway where towing and recreational vehicle traffic is heaviest in summer. Sustained towing at highway speed in July heat is the most common head gasket stress scenario for Riverton vehicles — a water pump or thermostat that can\'t keep up under tow load will reveal itself on this corridor before a full failure.' },
          { name: 'Jordan River Narrows — SR-68 South of Riverton', distance: '8 min south', tip: 'The narrow canyon segment south of Riverton where winding road grades with a loaded trailer create sustained high-torque, high-heat conditions for cooling systems. Late summer trailer towing through here — when ambient temperatures are already at their peak — is one of the highest head gasket stress scenarios from this city.' },
          { name: 'Mountain View Corridor & Bangerter Junction', distance: '10 miles south of shop', tip: 'The starting point for the freeway leg north to our shop. Head east on Bangerter to I-15, then north on I-15 about 8 miles to the 2700 South exit in South Salt Lake, then east to Crystal Ave.' }
        ],
      ...
      'herriman': {
        ...
        landmarks: [
          { name: 'Herriman Main Street — 13200 South Hillside Grade', distance: '15 min south', tip: 'The main Herriman residential spine where hillside grades exceed 10% in several sections. Daily uphill drives returning home in summer — engine at temperature, A/C at full load, steep grade — put cooling systems under exactly the sustained high-load condition that reveals marginal head gasket sealing well before any flat-ground symptom appears.' },
          { name: 'Butterfield Canyon Road Approach — Upper Herriman', distance: '10 min south', tip: 'The access road toward Butterfield Canyon from upper Herriman. The steep grade through loose shale and exposed switchbacks creates among the most demanding cooling conditions for Herriman vehicles — a full-throttle climb at altitude with summer heat and A/C on.' },
          { name: 'Mountain View Corridor North Entry — Herriman', distance: '15 miles south of shop', tip: 'The starting point for the commute north from Herriman to our shop. Take Mountain View Corridor north until it connects with I-15, then continue north about 8 miles to the 2700 South exit in South Salt Lake.' }
        ],
      ...
      'kearns': {
        ...
        landmarks: [
          { name: '5400 South & 4800 West — Western Kearns Residential', distance: '6 min west of shop', tip: 'The main western Kearns residential corridor where high-mileage daily drivers accumulate miles on flat terrain. Kearns head gasket failures are chemistry-driven more than heat-driven — aging coolant attacks aluminum head surfaces gradually, and this corridor\'s vehicles are often first to show it at the 120,000–150,000 mile mark.' },
          { name: 'SR-201 & Kearns Interchange — Flat Mileage Corridor', distance: '4 min west', tip: 'The Kearns access point to SR-201 westbound, where flat high-mileage commuting accumulates. Sustained flat-terrain driving doesn\'t stress cooling systems the way canyon grades do — but it does accumulate the mileage that makes coolant chemistry the primary risk factor for head gasket failure in Kearns vehicles.' },
          { name: '5400 South & State Street', distance: '3 min from shop', tip: 'The main junction coming east from Kearns to our shop. Turn north on State Street from 5400 South and continue 1.5 miles — Crystal Ave is on the left. We\'re halfway down the block at 144 W Crystal Ave.' }
        ],
      ...
      'midvale': {
        ...
        landmarks: [
          { name: 'I-15/I-215 Interchange — 7200 South Thermal Zone', distance: '4 miles south of shop', tip: 'The interchange congestion zone where Midvale vehicles mix high-speed freeway approach with stop-and-go — thermal cycling that stresses cooling system hoses, thermostat seals, and gasket surfaces differently than either driving pattern alone. High-mileage vehicles running this interchange daily develop cooling issues at a predictable rate past 100,000 miles.' },
          { name: 'Midvale Center TRAX Station — Blue Line', distance: '5 miles south of shop', tip: 'The most convenient Blue Line stop for Midvale customers whose vehicle can\'t safely be driven. Board heading north and ride to Central Pointe — a 3-minute walk to our shop. If your car is overheating, don\'t drive it — call us first and ask about free towing on qualifying repairs.' },
          { name: '7200 South & 700 West', distance: '4 miles south of shop', tip: 'Western Midvale landmark on the route north to our shop. From here, head east to State Street, then north about 4 miles — Crystal Ave is on the left just past the 2700 South light at 144 W Crystal Ave.' }
        ],
  ...
  'lift-leveling-kit-installation': {
    ...
    cities: {
      'sugar-house': {
        intro: 'Sugar House trucks live two lives — daily urban commuter by week, Parleys Canyon rig on weekends. A leveling kit handles both without compromise. We\'re 3 miles south — about 5 minutes on Highland Drive.',
        localContent: 'The I-80 on-ramp at 1300 East puts Sugar House trucks at the base of Parleys Canyon within minutes, but stock trucks with front-end rake lose approach angle and limit tire options on the canyon\'s rougher pull-offs and trailhead access roads. A leveling kit corrects that nose-down stance, improves approach angle for unpaved segments, and opens up 285/70R17 fitment without rubbing — all while keeping the truck usable for everyday city driving. Bonneville Shoreline Trail access at the base of the Wasatch foothills is practically a neighborhood amenity for Sugar House residents, and proper clearance matters on rocky trail approaches.',
        localTip: 'After a leveling kit install, have your headlights re-aimed before the first night drive. Stock headlights are aimed to compensate for factory rake — level the truck and they\'ll point higher than intended.',
        landmarks: [
          { name: 'I-80 Parleys Canyon On-Ramp — 1300 East', distance: '2 min north of shop', tip: 'The immediate gateway to canyon driving for Sugar House trucks. From here you\'re at the Parleys Canyon trailheads in about 10 minutes — exactly the terrain where a leveling kit and AT tires pay off most.' },
          { name: 'Bonneville Shoreline Trailhead — 2500 E Wasatch Drive', distance: '4 min northeast', tip: 'The closest off-pavement access point for Sugar House truck owners. The rocky approach road to the upper trailhead is where stock suspension clearance runs out. Leveled trucks with 285s navigate it without difficulty.' },
          { name: '2100 South & Highland Drive', distance: '2 min north of shop', tip: 'The main Sugar House arterial on the route south to our shop. Head south on Highland Drive from 2100 South — Crystal Ave is about 2 minutes ahead on the right.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Sugar House UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Sugar House trucks — 3 miles, 5 min. Parleys Canyon & Bonneville Shoreline ready. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'millcreek': {
        intro: 'Millcreek Canyon Road has tight switchbacks that punish trucks with long overhangs and no clearance. The right lift size matters more here than almost anywhere in the valley. We\'re 3 miles — about 7 minutes on 3300 South.',
        ...
        localTip: 'Before committing to a lift height for Millcreek Canyon use, measure your truck\'s wheelbase — longer wheelbase trucks with tall lifts gain clearance but lose departure angle on tight switchback turns. A 3- to 4-inch kit hits the right balance for the canyon.',
        landmarks: [
          { name: 'Millcreek Canyon Trailhead — 3800 S Millcreek Canyon Rd', distance: '5 min east of shop', tip: 'The entry point for Millcreek Canyon Road, where switchbacks and rocky trailhead spurs reward trucks with proper clearance. This is the terrain that reveals the practical difference between a quality lift and a basic spacer kit.' },
          { name: 'Wheeler Historic Farm — 6351 S 900 E', distance: '3 min south of canyon route', tip: 'A recognizable Millcreek landmark near the 3300 South corridor. From here, head west on 3300 South to Highland Drive — our shop is 3 miles further on Crystal Ave.' },
          { name: '3300 South & Highland Drive', distance: '3 min from shop', tip: 'The main junction heading from Millcreek toward our shop. Turn north on Highland Drive from 3300 South — Crystal Ave is about 3 minutes ahead on the left.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Millcreek UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Millcreek trucks — 3 miles, 7 min. Millcreek Canyon switchback-ready builds. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'murray': {
        intro: 'Murray trucks spend weekdays on I-215 and weekends pointed toward the Cottonwood Canyons. A leveling kit that tolerates highway on-ramps and canyon grades equally is the practical choice. We\'re 4 miles north — about 8 minutes on State Street.',
        localContent: 'Murray\'s easy I-215 access is a double-edged lift-kit consideration: the sweeping on-ramps at 45+ mph require a lift that doesn\'t add body roll or degrade high-speed stability, while the canyon destinations those ramps lead to require actual clearance and capable all-terrain tires. Many Murray truck owners are daily commuters who also want to get into the canyons on a Saturday morning — a 2-inch leveling kit with a quality shock upgrade and 285/70s satisfies both conditions without the harshness of a tall spacer lift on freeway drives.',
        localTip: 'For trucks that split time between I-215 highway commuting and Cottonwood Canyon trail access, upgrade the front struts when you level — a quality strut handles both the freeway sweeper ramps and the rocky canyon approach roads better than the stock unit under added preload.',
        landmarks: [
          { name: 'I-215 Southbound On-Ramp — 4500 South', distance: '4 min south of shop', tip: 'The main Murray freeway access point toward the Cottonwood Canyons. This sweeping on-ramp at highway speed is where lift stability matters — a quality leveling kit with upgraded struts handles it cleanly.' },
          { name: 'Fashion Place Mall — 6191 S State Street', distance: '4 miles south on State St', tip: 'A clear landmark on the State Street route from Murray toward our shop. From Fashion Place heading north, it\'s a straight 3.5-mile drive to Crystal Ave — where our shop is half a mile west.' },
          { name: 'Murray Park — 296 E 5300 South', distance: '3 min south of shop', tip: 'A recognizable Murray landmark and the Jordan River Parkway trailhead. Head north from Murray Park on State Street and Crystal Ave is about 2.5 miles ahead on the left.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Murray UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Murray trucks — 4 miles, 8 min. Freeway-stable and canyon-ready leveling kits. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'salt-lake-city': {
        intro: 'Salt Lake City trucks often serve two roles that demand different things from a lift: pavement navigability in dense urban traffic and real off-road capability when the city grid ends at the Wasatch foothills. We\'re 4 miles south — about 10 minutes.',
        localContent: 'Downtown Salt Lake City\'s tight parking structures and narrow Capitol Hill streets create an unusual lift constraint: trucks need clearance for real Wasatch terrain, but a tall lift makes urban parking and multi-level garage ramps genuinely difficult. A 2-inch leveling kit with the right tire choice splits this difference well — it improves approach angle on Bonneville Shoreline\'s rocky lower sections, clears 285/70s for actual traction, and doesn\'t add enough height to make a parking structure a logistics problem. Central Pointe TRAX is a 3-minute walk from our shop if you\'d rather drop the truck and take transit for the day.',
        localTip: 'SLC trucks that park downtown daily should verify their post-lift height against the parking structure they use most — a 2-inch leveled truck at 6\' 8\' clears most downtown garages, but a 4-inch lift at 7\' 2\' does not.',
        landmarks: [
          { name: 'Bonneville Shoreline Trailhead — Red Butte Canyon area', distance: '5 min east', tip: 'The closest rocky off-road access for SLC trucks. The trailhead approach road is unpaved and has ruts where stock clearance runs out — the exact terrain a leveling kit and AT tires address.' },
          { name: 'Central Pointe TRAX Station — 900 W / 2100 S', distance: '0.3 miles from shop', tip: 'The most convenient transit option for SLC customers dropping a truck for the day. Walk 3 minutes east to 144 W Crystal Ave, ride TRAX back downtown, and pick up when we call.' },
          { name: 'I-80 Eastbound On-Ramp — 600 S / 700 W', distance: '4 min northwest of shop', tip: 'The main I-80 east on-ramp from downtown SLC toward Parleys Canyon. From here, Parleys Summit trailheads are about 12 miles — real terrain where clearance and AT tires matter.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Salt Lake City UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for SLC trucks — 4 miles, 10 min. Urban-drivable, Wasatch-ready lifts. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'taylorsville': {
        intro: 'Taylorsville trucks do real towing work — and a leveling kit that corrects nose-dive under trailer load is a functional upgrade, not just cosmetic. We\'re 5 miles east — about 10 minutes on 4700 South.',
        localContent: 'Many Taylorsville truck owners use their rigs to tow boats, utility trailers, or gear toward the Tooele Valley and Cottonwood Canyons — and under trailer tongue weight, a factory-rake truck drops its nose further and pitches back, reducing headlight aim and front approach angle simultaneously. A leveling kit corrects this: keep the truck flat under tongue load, restore proper headlight aim, and open up room for a slightly taller all-terrain tire without adding a harsh ride. I-215\'s sweeping on-ramps also reward a quality strut upgrade over a basic spacer — stability at 55 mph matters more when you\'re towing.',
        localTip: 'Before your first tow trip after a leveling install, adjust your trailer brake gain — the changed suspension geometry can affect how weight transfers under braking, and what worked before may need minor tuning with the new setup.',
        landmarks: [
          { name: '4700 South & I-215 Interchange', distance: '4 min west of shop', tip: 'The main freeway junction for Taylorsville towing runs toward the Cottonwood Canyons and Tooele County. The sweeping on-ramp here at 45 mph is where suspension quality matters most when towing — worth upgrading struts alongside the leveling kit.' },
          { name: 'Meadowbrook TRAX Station — 3900 S 700 W', distance: '5 min northwest of shop', tip: 'A transit option for Taylorsville customers dropping the truck for a same-day install. Board the Red Line here and ride to Central Pointe Station — 3 minutes from our shop on foot.' },
          { name: '4700 South & State Street', distance: '3 min from shop', tip: 'The main junction coming from Taylorsville. Turn north on State Street from 4700 South — Crystal Ave is about 2 miles ahead on the right. Our shop is at 144 W Crystal Ave.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Taylorsville UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Taylorsville trucks — 5 miles, 10 min. Towing-corrected leveling kits, Tooele & canyon access. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'west-valley-city': {
        intro: 'West Valley City has one of the valley\'s largest concentrations of contractor and trades trucks. A leveling kit here is almost always a functional upgrade first, cosmetic second. We\'re 7 miles east — about 12 minutes via I-215.',
        localContent: 'West Valley City\'s large contractor and trades-worker population uses trucks as work tools — landscaping rigs, contractor beds, and utility vehicles that haul real payload daily. Under load, these trucks sit nose-up and bed-down from the factory rake, which gets worse with a full payload. A leveling kit corrects that stance, improves approach angle on dirt job sites, and is a prerequisite for fitting a full-size spare under the bed without dragging. West Valley also has quick access to Bacchus Highway and the Oquirrh Mountain foothills where weekend trail use compounds the practical case for added clearance.',
        localTip: 'West Valley contractors: if you\'re running a leveling kit on a truck with a payload above 1,200 lbs regularly, pair it with a rear add-a-leaf or helper spring. The leveling kit addresses front rake; the helper spring keeps the rear from squatting under bed load.',
        landmarks: [
          { name: 'Bacchus Highway / SR-111 — Oquirrh Mountain Entry', distance: '7 min west', tip: 'The main access corridor to the Oquirrh Mountain OHV staging areas from West Valley. The dirt roads off Bacchus Highway are where added clearance and AT tires make a real difference — and where stock suspension clearance runs short on rocky approaches.' },
          { name: 'USANA Amphitheatre — 5150 Upper 5 Mile Creek Rd', distance: '5 min west of shop route', tip: 'A well-known West Valley City landmark near the 3500 South corridor. From the amphitheatre area, head east on 3500 South — our shop is about 10 minutes from here via State Street.' },
          { name: '3500 South & State Street', distance: '2 min from shop', tip: 'The main junction coming east from West Valley City. Turn north on State Street from 3500 South, then immediately left on Crystal Ave — we\'re halfway down the block at 144 W Crystal Ave.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near West Valley UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for West Valley trucks — 7 miles, 12 min. Contractor-functional leveling, Oquirrh Mountain access. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'holladay': {
        intro: 'Holladay trucks have Big Cottonwood Canyon practically in the backyard — but canyon traction requirements mean clearance and the right tires aren\'t optional for winter use. We\'re 5 miles north — about 9 minutes on Highland Drive.',
        localContent: 'Big Cottonwood Canyon\'s traction restrictions require either all-wheel drive with mountain-rated tires or chains — and a leveling kit that opens up a proper 285/70R17 or 265/70R17 mountain-rated all-terrain tire satisfies the AWD tire requirement at the canyon entrance while giving meaningful clearance on the rocky summer trail approaches. Holladay trucks that ski Brighton or Solitude regularly also benefit from the improved departure angle on the snow-packed canyon road where stock suspension bottoms out on packed berms. Highland Drive\'s long downhill grade into Holladay is manageable at any lift height, but the canyon approach is where the kit earns its keep.',
        localTip: 'If you\'re installing a leveling kit primarily for Big Cottonwood Canyon winter use, select tires that meet the canyon\'s traction restriction requirements — a 3-peak mountain snowflake symbol AT tire satisfies both the clearance goal and the traction restriction in one install.',
        landmarks: [
          { name: 'Big Cottonwood Canyon Entrance — Wasatch Blvd & 7200 S', distance: '6 min east of shop', tip: 'The traction restriction checkpoint for Holladay trucks heading to Brighton or Solitude. Canyon entrance requirements are where a proper leveling kit and mountain-rated AT tire combination pays off — stock clearance with all-season tires won\'t always pass.' },
          { name: 'Fort Union Boulevard & Highland Drive', distance: '4 min from shop', tip: 'The main Holladay arterial connecting to Highland Drive north. Head north from Fort Union on Highland Drive — our shop is about 4 minutes ahead on Crystal Ave, the left turn just before 2100 South.' },
          { name: '4500 South & Highland Drive', distance: '4 min from shop', tip: 'The main Holladay landmark on the Highland Drive route north to our shop. From here, continue north on Highland Drive through Murray and into South Salt Lake — Crystal Ave is the left turn about 4 miles ahead.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Holladay UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Holladay trucks — 5 miles, 9 min. Big Cottonwood traction restriction-ready lifts. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'cottonwood-heights': {
        intro: 'Cottonwood Heights trucks deal with traction restrictions at Little Cottonwood Canyon that effectively require proper AT tires — and a leveling kit is the right platform to run them. We\'re 6 miles north — about 10 minutes.',
        localContent: 'Little Cottonwood Canyon\'s traction restrictions are enforced at the canyon gate, and a lifted truck with mountain-rated all-terrain tires satisfies the AWD/4WD requirement far more reliably than a stock truck on all-seasons. The canyon\'s switchback grades and the groomed forest service road segments near Snowbird and Alta have sections where ground clearance is the difference between clearing snow berms and high-centering. Cottonwood Heights trucks are also frequently used as ski-day haulers — loaded with gear, passengers, and occasionally a trailer — conditions where a leveling kit\'s correction of nose-down stance under load pays off on approach angles.',
        localTip: 'After a leveling kit install, verify your AT tire choice meets the 3-peak mountain snowflake symbol before the first canyon run — some all-terrain tires carry the mountain snowflake, others don\'t. The canyon checkpoint enforces it.',
        landmarks: [
          { name: 'Little Cottonwood Canyon Entrance — 9000 S Wasatch Blvd', distance: '5 min east of shop', tip: 'The traction restriction checkpoint where the practical case for a leveling kit and mountain AT tires becomes real. Cottonwood Heights trucks without proper tires get turned back here — a leveling kit that opens up the right tire options pays for itself at this gate.' },
          { name: 'Big Cottonwood Canyon Rd & Wasatch Blvd', distance: '4 min east of shop', tip: 'The entrance to Big Cottonwood Canyon, the second canyon accessible from Cottonwood Heights. Both canyons have similar traction requirements and rocky trailhead approach roads where clearance matters in summer and tires matter in winter.' },
          { name: 'Fort Union Blvd & Highland Drive', distance: '4 min from shop', tip: 'The main turn heading north toward our shop from Cottonwood Heights. Take Highland Drive north from Fort Union all the way through Holladay and Sugar House — Crystal Ave is about 4 miles ahead on the left.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Cottonwood Heights UT | Scott\'s',
        metaDesc: 'Lift & leveling kit installation near Cottonwood Heights — 6 miles, 10 min. Little Cottonwood traction restriction-ready. Scott\'s Auto. (801) 485-4089.'
      },
      'sandy': {
        intro: 'Sandy is one of the valley\'s best-positioned cities for a lift kit install: Corner Canyon\'s rocky doubletrack is minutes away, and the rocky trail approaches are where cheap spacer kits show their limits. We\'re 8 miles north — about 12 minutes on I-15.',
        localContent: 'Corner Canyon\'s Traverse Ridge and the surrounding rocky OHV network require suspension that absorbs sustained impact on washboard and rocky doubletrack — a basic spacer lift transfers all of that force directly to factory struts and wears them out fast. Sandy trucks that run Corner Canyon regularly see the longest kit life from a quality coilover or strut-based lift with a longer shock travel than the stock unit. Little Cottonwood Canyon approach roads and the canyon\'s traction restrictions add the same argument that applies to Cottonwood Heights and Holladay: the right tire on a properly lifted truck is a prerequisite for reliable canyon access.',
        localTip: 'Sandy trucks running Corner Canyon\'s rocky doubletrack should avoid budget spacer kits — they transfer all trail impact directly to factory struts at the added preload angle. A quality lift kit with upgraded front shocks lasts significantly longer on that terrain.',
        landmarks: [
          { name: 'Corner Canyon Trailhead — Traverse Ridge Road', distance: '8 min southeast', tip: 'The main access point for Corner Canyon\'s rocky OHV network. Washboard and loose rock on this trail system are exactly where a quality shock-based lift kit separates from a basic spacer — a cheap spacer kit wears out fast on this terrain.' },
          { name: 'Sandy Civic Center TRAX Station — 8680 S State Street', distance: '8 miles south', tip: 'The most convenient Blue Line station for Sandy customers dropping a truck for the day. Board here and ride north to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: '10600 South & I-15 Interchange', distance: '6 miles south of shop', tip: 'The main freeway entry for most Sandy drivers. Head north on I-15 from here — 6 miles to the 2700 South exit, then east to Crystal Ave. Most lift kit installs are done same-day.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Sandy UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Sandy trucks — 8 miles, 12 min. Corner Canyon & Little Cottonwood ready. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'draper': {
        intro: 'Draper is home to Corner Canyon — one of the most technical OHV trail networks in the valley. The terrain here demands a real lift kit, not a spacer. We\'re 12 miles north — about 15 minutes on I-15.',
        localContent: 'SunCrest residents deal with steep, winding access roads daily, and while those roads don\'t require off-road clearance, they do reward trucks with solid suspension handling under the cornering load of switchback grades. Corner Canyon\'s upper trails beyond the paved sections have loose rock and water bars where a quality 3- to 4-inch suspension lift provides the clearance and shock travel to navigate without damage. Draper also has an outdoor-oriented population that does real towing to Jordanelle Reservoir and the Uintas — a leveling kit that corrects tow stance for trailers over 5,000 lbs makes those runs measurably safer.',
        localTip: 'Corner Canyon\'s rocky upper trails reveal spacer kit weaknesses quickly. If you\'re running those trails more than a few times a year, a quality suspension lift with a proper shock budget will outlast a cheap spacer on that terrain by years.',
        landmarks: [
          { name: 'Corner Canyon / Suncrest OHV Staging Area', distance: '8 min southeast', tip: 'The primary staging area for Draper\'s OHV and mountain bike community. The rocky doubletrack beyond the paved approach is where quality suspension lift kits earn their keep — this is the terrain that shows spacer kit weaknesses fast.' },
          { name: 'Point of the Mountain — I-15 Grade at the SL/Utah County line', distance: '9 miles south of shop', tip: 'The steep I-15 grade between Salt Lake and Utah counties. Once you crest the summit heading north, our exit is about 9 miles ahead at 2700 South in South Salt Lake.' },
          { name: 'Draper Town Center TRAX Station — 11400 S Bangeter Hwy', distance: '12 miles south', tip: 'The most convenient Blue Line station for Draper customers dropping a truck for the day. Board here and ride north to Central Pointe Station — 3 minutes east on foot to our shop.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Draper UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Draper trucks — 12 miles, 15 min. Corner Canyon & SunCrest-ready suspension lifts. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'west-jordan': {
        intro: 'West Jordan\'s working-truck culture and direct Oquirrh Mountain access make a leveling kit a practical daily upgrade, not just a trail toy. We\'re 8 miles northeast — about 12 minutes.',
        localContent: 'West Jordan has a strong landscaping and contractor truck culture — rigs that carry real payload, tow utility trailers, and need a suspension that handles work-site terrain without bottoming out. A 2-inch leveling kit corrects the factory nose-down stance under payload, allows a full-size spare to clear under the bed, and improves approach angles on the rough dirt access roads common around job sites. The Oquirrh Mountain OHV staging areas off Bacchus Highway are a short drive west for weekend trail runs, where the same leveling kit that helped at work earns its keep on dirt.',
        localTip: 'West Jordan contractors: a leveling kit on a heavy-use work truck should be accompanied by an alignment check and a torque check at 500 miles — work-site vibration and payload cycles settle the new hardware faster than road-only driving.',
        landmarks: [
          { name: 'Oquirrh Mountain OHV Staging — near 8000 S Bacchus Hwy', distance: '7 min west', tip: 'The primary access point for West Jordan trucks heading to the Oquirrh Mountain OHV trail network. The staging area\'s dirt approach and the trail network beyond are where a leveling kit and AT tires earn their keep from this city.' },
          { name: '7800 South Commercial Area — Redwood Road', distance: '5 miles south of shop', tip: 'The main West Jordan commercial corridor. From here, head north on Redwood Road to the UT-201 connector, then east to I-15 north — our 2700 South exit is about 7 miles up the freeway.' },
          { name: '5400 South & State Street', distance: '3 miles south of shop', tip: 'An alternate route from West Jordan. Turn north on State Street from 5400 South and continue about 2.5 miles — Crystal Ave will be on your left. Our shop is at 144 W Crystal Ave, halfway down the block.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near West Jordan UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for West Jordan trucks — 8 miles, 12 min. Contractor-functional leveling, Oquirrh OHV access. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'south-jordan': {
        intro: 'South Jordan\'s outdoor recreation culture and Oquirrh foothill proximity support real overland builds — full suspension lifts on trucks that head toward Tooele County backcountry on weekends. We\'re 10 miles north — about 14 minutes.',
        localContent: 'South Jordan\'s rapid growth has attracted a younger, outdoors-oriented demographic with trucks set up for overlanding — roof-top tents, long-range fuel, recovery gear, and suspension built for loaded two-track travel. SR-111 and Bacchus Highway open up Tooele County\'s extensive backcountry OHV network within 20 minutes of the Daybreak neighborhoods. Full suspension lift kits on half-ton and three-quarter-ton trucks here are almost always loaded builds — leveling kits alone are common on tow rigs where stance correction under tongue load matters more than trail clearance.',
        localTip: 'South Jordan overland builds running heavy loaded weights — recovery gear, sleeping platforms, water, and fuel — should verify their lift kit\'s rated load capacity before install. Full-build overlanders often exceed the load assumptions of standard lift kits designed for stock-weight trucks.',
        landmarks: [
          { name: 'Bangerter Highway & SR-111 Interchange', distance: '10 min south', tip: 'The gateway to Tooele County\'s OHV network from South Jordan. SR-111 south from here opens up the Oquirrh Mountain trail system and the western valley backcountry that South Jordan overland builds are set up for.' },
          { name: 'Daybreak Parkway TRAX Station', distance: '10 miles south', tip: 'The Blue Line station for Daybreak customers dropping a truck for the day. Board here and ride north to Central Pointe Station — 3 minutes from our shop on foot at 144 W Crystal Ave.' },
          { name: 'Bangerter Highway & I-15 Interchange', distance: '8 miles south of shop', tip: 'The main freeway junction for most South Jordan drivers. Head north on I-15 from here — it\'s about 8 miles to the 2700 South exit in South Salt Lake. Most lift kit installs are completed same-day.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near South Jordan UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for South Jordan trucks — 10 miles, 14 min. Overland builds & Tooele backcountry access. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'riverton': {
        intro: 'Riverton trucks do serious towing work — to Jordanelle, to Strawberry, to the Uintas. A leveling kit that corrects hitch angle and trailer sway under load is a safety upgrade as much as a suspension one. We\'re 12 miles north — about 16 minutes.',
        localContent: 'Riverton\'s outdoor recreation culture centers heavily on towing — boat trailers to Jordanelle Reservoir and Deer Creek, ATV trailers to the Uinta backcountry, and utility trailers for property maintenance on bigger lots. Under full tongue load, a factory-rake truck pitches back, misaligns the trailer coupler, and worsens trailer sway. A leveling kit corrects the base stance so trailer couplers seat properly and hitch height stays stable under tongue load. Riverton also has direct access to the Jordan Narrows OHV corridor via SR-68, where proper clearance and a capable tire make a meaningful difference on the rocky wash crossings.',
        localTip: 'After a leveling kit install, re-measure your hitch receiver height with the truck loaded to your typical trailer tongue weight. A leveled truck changes hitch geometry, and coupler height must match ball height within half an inch for safe trailer tracking.',
        landmarks: [
          { name: 'Jordan Narrows OHV Area — SR-68 south of Riverton', distance: '10 min south', tip: 'The main off-road access corridor from Riverton toward the Jordan Narrows wash crossings. Rocky approaches and seasonal wash crossings here are where AT tires and clearance matter for Riverton trucks.' },
          { name: 'Bangerter Highway & Mountain View Corridor Junction', distance: '10 miles south of shop', tip: 'The key starting point for the freeway leg north to our shop. Head east on Bangerter to I-15, then north on I-15 for about 8 miles to the 2700 South exit in South Salt Lake.' },
          { name: '2700 South exit off I-15 — South Salt Lake', distance: '1 mile from shop', tip: 'The turn-off for our shop coming from Riverton. Head east from the exit and turn right on Crystal Ave — our shop is at 144 W Crystal Ave on the left side of the block.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Riverton UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Riverton trucks — 12 miles, 16 min. Tow-stance correction & Jordan Narrows access. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'herriman': {
        intro: 'Herriman\'s Oquirrh Mountain foothills start at the edge of several neighborhoods — loose shale and steep descent grades demand a full suspension lift, not a leveling spacer. We\'re 15 miles north — about 20 minutes.',
        localContent: 'Herriman has more direct residential access to Oquirrh Mountain terrain than almost any other Salt Lake Valley community — the foothills start within walking distance of some neighborhoods. That terrain involves loose shale, steep descent grades, and rocky wash crossings where a budget spacer lift transmits every impact through factory struts at increased preload angle, wearing them quickly. A quality full suspension lift with appropriate shock travel handles this terrain in ways a spacer doesn\'t — the extra shock length absorbs the impacts that would otherwise bottom out a spacer-lifted strut. SR-111 opens Herriman to Tooele County\'s broader backcountry network for weekend runs.',
        localTip: 'Herriman\'s loose shale Oquirrh terrain puts downward pressure on shocks during descents — a quality shock with sufficient rebound damping keeps the front end planted. Cheap spacer kits on this terrain bounce on descents and lose traction unpredictably.',
        landmarks: [
          { name: 'Oquirrh Mountain Foothills OHV Staging — near 13400 S Bacchus Hwy', distance: '5 min from Herriman neighborhoods', tip: 'The nearest OHV staging area to Herriman\'s residential streets. Loose shale and steep grades beyond this staging area are where the quality difference between a suspension lift and a basic spacer kit becomes obvious.' },
          { name: 'Mountain View Corridor North Entrance — Herriman area', distance: '15 miles south of shop', tip: 'The main route heading north from Herriman toward our shop. Take Mountain View Corridor north until it connects with I-15, then north on I-15 to the 2700 South exit in South Salt Lake.' },
          { name: '5400 South Interchange off I-15', distance: '5 miles south of shop', tip: 'A useful midpoint landmark on the I-15 run north from Herriman. From here, our exit is just 3 more miles — continue to 2700 South, then east about a mile to Crystal Ave and turn right.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Herriman UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Herriman trucks — 15 miles, 20 min. Oquirrh shale and steep grades demand quality suspension. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'kearns': {
        intro: 'Kearns trucks run a practical daily-driver lift — SR-201 and Bacchus Highway toward Tooele County OHV areas are the weekend destination, and the kit needs to handle both freeway and trail. We\'re 7 miles east — about 12 minutes on 5400 South.',
        localContent: 'Kearns\'s SR-201 corridor puts Tooele County\'s OHV network within 20 minutes — and that terrain rewards a leveling kit and proper AT tire over the stock setup. But Kearns trucks are also daily commuters on 5400 South and I-15, which means the same kit has to handle highway driving without excessive road noise or a harsh ride. A 2-inch leveling kit with a quality shock upgrade and 265/70R17 or 275/65R18 all-terrain tire hits this balance well — enough clearance for Tooele trail access, low enough noise and ride quality for daily commuting.',
        localTip: 'Kearns trucks running SR-201 toward Tooele County should confirm AT tire load ratings before install — the industrial corridor\'s road debris is harder on sidewalls than regular highway, and a light-truck rated tire handles it better than a standard passenger-metric all-terrain.',
        landmarks: [
          { name: 'SR-201 & Bacchus Highway Interchange', distance: '5 min west', tip: 'The gateway to the Tooele County OHV network from Kearns. Bacchus Highway south from here leads to the Oquirrh Mountain trailheads where Kearns trucks most often end up on weekends — clearance and AT tires matter on the rocky approach roads.' },
          { name: 'Utah Olympic Oval — 5662 Cougar Lane', distance: '2 miles east of central Kearns', tip: 'A well-known Kearns landmark near the 5400 South route east to our shop. From the Oval, continue east on 5400 South to State Street, then north 1.5 miles to Crystal Ave — our shop is on the left.' },
          { name: '5400 South & State Street', distance: '3 min from shop', tip: 'The main junction coming east from Kearns. Turn north on State Street from 5400 South and continue 1.5 miles — Crystal Ave is on the left. We\'re halfway down the block at 144 W Crystal Ave.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Kearns UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Kearns trucks — 7 miles, 12 min. SR-201 corridor & Tooele OHV-ready. Written estimate. Scott\'s Auto. (801) 485-4089.'
      },
      'midvale': {
        intro: 'Midvale sits at the crossroads of the valley\'s two main off-road corridors — east toward the Cottonwood Canyons, west toward the Oquirrh OHV areas. Both are within 20 minutes. We\'re 5 miles north — about 8 minutes on State Street.',
        localContent: 'Midvale\'s central south valley location gives truck owners access to two very different terrain types: the rocky, technical Cottonwood Canyon approach roads to the east, and the Oquirrh Mountain dirt network and Tooele backcountry to the west via I-215. The kit that works for both is a 2- to 3-inch leveling setup with a quality all-terrain tire in the 275/65 to 285/70 range — enough clearance for rocky canyon approaches, enough sidewall for loose Oquirrh shale, and manageable road noise on the freeway segments between. Central Pointe TRAX makes same-day drop-off easy if you want to leave the truck and come back when the install is done.',
        localTip: 'Midvale\'s dual corridor access means your AT tire choice matters — canyon rock and Oquirrh shale stress tires differently. A tire with a chunky tread block handles both terrain types better than a highway-biased all-terrain that\'s really just a cosmetic upgrade.',
        landmarks: [
          { name: 'I-215 Fort Union Interchange — Cottonwood Canyon Access', distance: '4 min east of shop', tip: 'The main freeway connection from Midvale to the Cottonwood Canyons. From here, Highland Drive continues south to Big Cottonwood Canyon in about 10 minutes — the eastern terrain that Midvale truck owners most often access.' },
          { name: 'Midvale Center TRAX Station — 7200 S State Street', distance: '5 miles south of shop', tip: 'The most convenient Blue Line stop for Midvale customers dropping a truck for an all-day install. Board here heading north and ride to Central Pointe — 3 minutes from our shop on foot.' },
          { name: '7200 South & State Street', distance: '4 miles south of shop', tip: 'The main Midvale commercial intersection on State Street. Head north from here for about 4 miles straight — Crystal Ave will be on your left just past the 2700 South light. We\'re halfway down the block.' }
        ],
        metaTitle: 'Lift & Leveling Kit Near Midvale UT | Scott\'s Auto',
        metaDesc: 'Lift & leveling kit installation for Midvale trucks — 5 miles, 8 min. Canyon east or Oquirrh west — both require the right lift. Written estimate. Scott\'s Auto. (801) 485-4089.'
      }
    }
  },
  ...
  'check-engine-light-engine-repair': {
    ...
    cities: {
      'sugar-house': {
        ...
        landmarks: [
          { name: 'I-80 On-Ramp at 1300 East — Short-Trip Cold Start Zone', distance: '2 min north of shop', tip: 'The I-80 ramp corridor is where Sugar House short-trip driving patterns concentrate — cold starts followed by brief high-RPM ramp pulls that never fully warm the engine. This pattern builds the intake carbon and EGR fouling we most commonly see from this zip code.' },
          { name: 'Central Pointe TRAX Station — 900 W / 2100 S', distance: '0.3 miles from shop', tip: 'If your vehicle can\'t be driven safely, Central Pointe is a 3-minute walk from our shop at 144 W Crystal Ave. Take TRAX from Sugar House to Central Pointe — repairs over $1,000 include free towing if you\'d rather not risk driving.' },
          { name: '2100 South & Highland Drive', distance: '1 min from shop', tip: 'The main Sugar House arterial, just 1 minute north of our shop. From this intersection, turn left on Crystal Ave — we\'re halfway down the block on the right at 144 W Crystal Ave.' }
        ],
      ...
      'millcreek': {
        ...
        landmarks: [
          { name: 'Big Cottonwood Canyon Road Entry — 7200 S Wasatch Blvd', distance: '6 min east of shop', tip: 'The canyon temperature transition that creates Millcreek\'s most common check engine patterns. Cold canyon air into a warm engine causes EVAP pressure differentials that trip small-leak codes — a common misdiagnosis as a fuel cap issue when the real cause is a canister or purge valve.' },
          { name: '3300 South & State Street', distance: '0.5 miles east of shop', tip: 'The main Millcreek commercial corridor where stop-and-go creates sustained low-speed catalytic converter loads. Vehicles running this corridor daily often develop P0420 codes earlier than mileage alone would predict.' },
          { name: '3300 South & Highland Drive', distance: '3 min from shop', tip: 'The main junction heading from Millcreek toward our shop. Turn north on Highland Drive from 3300 South — Crystal Ave is about 3 minutes ahead on the left at 144 W Crystal Ave.' }
        ],
      ...
      'murray': {
        ...
        landmarks: [
          { name: 'Intermountain Medical Center — 5121 S Cottonwood St', distance: '3 miles south of shop', tip: 'The medical center area generates some of Murray\'s densest stop-and-go — the repeated deceleration-to-stop pattern on State Street near this campus is the most common check engine light environment for Murray O2 sensor wear.' },
          { name: 'Murray Central TRAX Station', distance: '4 miles south', tip: 'The most convenient transit option for Murray drivers whose vehicle can\'t be driven safely. Board the Red Line here heading north, ride one stop to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: 'Fashion Place Mall — 6191 S State Street', distance: '4 miles south on State St', tip: 'A clear landmark on the State Street route from Murray to our shop. From Fashion Place heading north, it\'s a straight 3.5-mile drive to Crystal Ave on the left — we\'re halfway down the block.' }
        ],
      ...
      'salt-lake-city': {
        ...
        landmarks: [
          { name: 'University of Utah Campus — Medical Drive area', distance: '4 min northeast', tip: 'The campus and surrounding hospital district generate sustained idle conditions that prevent converters from fully regenerating — one of the most common check engine environments for SLC vehicles with catalytic converter codes.' },
          { name: 'Central Pointe TRAX Station — 900 W / 2100 S', distance: '0.3 miles from shop', tip: 'The closest TRAX stop to our shop. Both Red and Blue Lines stop here. Walk 3 minutes east on 2100 South, then right on Crystal Ave — critical if your SLC vehicle can\'t be safely driven to the shop.' },
          { name: 'I-80 Overpass on State Street', distance: '1 mile north of shop', tip: 'A clear route marker heading south from downtown SLC. Once you cross under I-80 on State Street, our shop is 1 mile ahead. Stay on State Street and turn right on Crystal Ave — we\'re on the left.' }
        ],
      ...
      'taylorsville': {
        ...
        landmarks: [
          { name: 'I-215 Southbound On-Ramp — 4700 South', distance: '4 min west of shop', tip: 'The thermal cycling zone for Taylorsville catalytic converters — sustained highway speed followed by the abrupt deceleration at the bottom of the off-ramp is the exact pattern that cracks converter substrates over time.' },
          { name: 'Meadowbrook TRAX Station — 3900 S 700 W', distance: '5 min northwest of shop', tip: 'A transit option for Taylorsville drivers whose vehicle can\'t be driven safely. Board the Red Line here and ride to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: '4700 South & State Street', distance: '3 min from shop', tip: 'The main junction coming from Taylorsville. Turn north on State Street from 4700 South — Crystal Ave is about 2 miles ahead on the right. Our shop is at 144 W Crystal Ave.' }
        ],
      ...
      'west-valley-city': {
        ...
        landmarks: [
          { name: 'USANA Amphitheatre Parking Area — 5150 Upper 5 Mile Creek Rd', distance: '5 min west', tip: 'A documented catalytic converter theft location during events. High-clearance trucks and SUVs left in the outer amphitheatre lots are targeted — if your check engine light appeared after an event night, check underneath before driving.' },
          { name: '3500 South & Redwood Road', distance: '4 min west', tip: 'The heart of West Valley\'s commercial stop-and-go corridor. The low-speed sustained loads on 3500 South prevent catalytic converters from reaching full operating temperature — one of the primary drivers of P0420 codes from this area.' },
          { name: '3500 South & State Street', distance: '2 min from shop', tip: 'The main junction coming east from West Valley City. Turn north on State Street from 3500 South, then immediately left on Crystal Ave — we\'re halfway down the block at 144 W Crystal Ave.' }
        ],
      ...
      'holladay': {
        ...
        landmarks: [
          { name: 'Fort Union Boulevard & Highland Drive', distance: '4 min from shop', tip: 'The altitude transition point for most Holladay daily commutes — drivers descending from 4,800 feet to 4,200 feet through this intersection experience the engine management adjustments that produce intermittent O2 and fuel trim codes.' },
          { name: 'Big Cottonwood Canyon Entry — Wasatch Blvd near 7200 S', distance: '6 min east of shop', tip: 'For Holladay vehicles used for canyon access, this is where EVAP pressure differentials from temperature change concentrate. Cold canyon air causes fuel vapor contraction that trips EVAP monitors on vehicles with aging canister seals.' },
          { name: '4500 South & Highland Drive', distance: '4 min from shop', tip: 'The main Holladay landmark on the Highland Drive route north to our shop. Continue north from here — our shop is about 4 minutes ahead at Crystal Ave, the left turn just before 2100 South.' }
        ],
      ...
      'cottonwood-heights': {
        ...
        landmarks: [
          { name: 'Little Cottonwood Canyon Entrance — 9000 S Wasatch Blvd', distance: '5 min east', tip: 'Cold-start canyon climbing from this point is the most common trigger for Cottonwood Heights check engine codes — O2 sensor delays and EGR carbon buildup both surface under the sustained load of the canyon grade in cold temperatures.' },
          { name: 'Big Cottonwood Canyon Rd & Wasatch Blvd', distance: '4 min east', tip: 'The second canyon corridor for Cottonwood Heights vehicles. EGR flow codes (P0401) are particularly common on vehicles used for both canyon corridors regularly — the sustained high-load climbs build carbon in the EGR passages faster than flat-valley driving.' },
          { name: 'Fort Union Blvd & Highland Drive', distance: '4 min from shop', tip: 'The main turn heading from Cottonwood Heights toward our shop. Take Highland Drive north from Fort Union through Holladay and Sugar House — Crystal Ave is about 4 miles ahead on the left at 144 W Crystal Ave.' }
        ],
      ...
      'sandy': {
        ...
        landmarks: [
          { name: 'Sandy Civic Center TRAX Station — 8680 S State Street', distance: '8 miles south', tip: 'The most convenient Blue Line station for Sandy customers whose vehicle can\'t be safely driven. Board here heading north and ride to Central Pointe Station — 3 minutes from our shop. Free towing applies to repairs over $1,000 if driving isn\'t safe.' },
          { name: '10600 South & State Street', distance: '6 miles south of shop', tip: 'The main Sandy commercial corridor where O2 sensor mileage codes accumulate fastest from freeway commuting. From here heading north on State Street, our shop is about 5 miles — turn left on Crystal Ave just past the 2700 South light.' },
          { name: 'Bell Canyon Access Road — eastern Sandy foothills', distance: '8 min east', tip: 'The foothill elevation zone where EVAP small-leak codes are most common for Sandy vehicles. At 4,700–5,000 feet on the Bell Canyon approach, fuel vapor pressure differentials regularly trip the EVAP monitor in spring and fall temperature swings.' }
        ],
      ...
      'draper': {
        ...
        landmarks: [
          { name: 'Point of the Mountain — I-15 Grade at the SL/Utah County Line', distance: '9 miles south of shop', tip: 'The daily grade that produces more O2 sensor and fuel trim codes for Draper commuters than any other single road segment. Sustained full-throttle climbing stresses upstream O2 sensors at a rate that flat-valley driving doesn\'t — check engine lights at high mileage from Draper often trace back to this grade.' },
          { name: 'SunCrest Drive Entry Point — upper Draper', distance: '8 min southeast', tip: 'Residential elevations above 5,000 feet in SunCrest push factory fuel trim calibrations to the edge of their range. A P0171 lean code on a SunCrest vehicle may be altitude-specific rather than a component failure — diagnosis with live data confirms which it is.' },
          { name: 'Draper Town Center TRAX Station — 11400 S Bangerter Hwy', distance: '12 miles south', tip: 'The most convenient Blue Line station for Draper customers whose vehicle can\'t be driven. Board here heading north and ride to Central Pointe Station — 3 minutes from our shop at 144 W Crystal Ave.' }
        ],
      ...
      'west-jordan': {
        ...
        landmarks: [
          { name: 'Mountain View Corridor & 7800 South — Thermal Cycling Zone', distance: '5 miles south of shop', tip: 'The sustained highway-to-full-stop cycling on Mountain View Corridor is the most common catalytic converter stress pattern for West Jordan vehicles. High-speed loads followed by abrupt stops at intersections prevent the converter from maintaining self-cleaning temperature consistently.' },
          { name: 'Jordan River Pkwy Park-and-Ride — near 7000 S Redwood Rd', distance: '4 miles south of shop', tip: 'A documented catalytic converter theft location for trucks and SUVs parked at the Jordan River trailhead park-and-ride. If your check engine light appeared after parking here, inspect the undercarriage before driving.' },
          { name: '5400 South & State Street', distance: '3 miles south of shop', tip: 'An alternate route from West Jordan. Turn north on State Street from 5400 South and continue about 2.5 miles — Crystal Ave will be on your left at 144 W Crystal Ave.' }
        ],
      ...
      'south-jordan': {
        ...
        landmarks: [
          { name: 'Bangerter Highway Grade Separations — 11400 S area', distance: '10 min south', tip: 'The thermal cycling zone for South Jordan catalytic converters — repeated acceleration-to-full-stop at Bangerter\'s grade-separated exits is the most common P0420 pattern we see from this corridor.' },
          { name: 'Daybreak Parkway TRAX Station', distance: '10 miles south', tip: 'The Blue Line station for South Jordan customers whose vehicle can\'t be safely driven. Board here and ride north to Central Pointe Station — 3 minutes from our shop. Free towing applies to repairs over $1,000.' },
          { name: 'Bangerter Highway & I-15 Interchange', distance: '8 miles south of shop', tip: 'The main freeway junction for most South Jordan drivers heading to our shop. Head north on I-15 — it\'s about 8 miles to the 2700 South exit in South Salt Lake, then east to Crystal Ave.' }
        ],
      ...
      'riverton': {
        ...
        landmarks: [
          { name: 'Bangerter Highway at 12300 South — High-Speed Exhaust Zone', distance: '12 min south', tip: 'Sustained high-speed driving on Bangerter from Riverton keeps exhaust temperatures elevated for the entire commute — the primary reason Riverton O2 sensors and catalytic converters wear faster than their mileage alone predicts.' },
          { name: 'Jordan River Flood Plain Roads — western Riverton', distance: '5 min west', tip: 'The seasonal humidity from the Jordan River corridor creates the moisture swings that stress EVAP charcoal canisters and purge valves — a specific geographic factor in why Riverton EVAP codes are more common than in drier upland communities.' },
          { name: 'Bangerter Highway & Mountain View Corridor Junction', distance: '10 miles south of shop', tip: 'The key starting point for the freeway leg north to our shop. Head east on Bangerter to I-15, then north on I-15 for about 8 miles to the 2700 South exit in South Salt Lake.' }
        ],
      ...
      'herriman': {
        ...
        landmarks: [
          { name: 'Herriman Hillside Neighborhoods — 5200 ft elevation zone', distance: '15 min south', tip: 'The highest residential elevations in the southwest valley, where O2 sensor feedback and fuel trim operate near the calibration limit. Herriman check engine codes from these neighborhoods are more often altitude-influenced than component failures — diagnosis with live data at both elevations confirms which it is.' },
          { name: 'Mountain View Corridor Entry — Herriman', distance: '15 miles south of shop', tip: 'The beginning of the long high-speed commute segment where Mountain View Corridor and I-15 combine to stress catalytic converters and O2 sensors over thousands of annual miles for Herriman commuters.' },
          { name: '5400 South Interchange off I-15', distance: '5 miles south of shop', tip: 'A useful midpoint landmark on the I-15 run north from Herriman. From here, our exit is 3 more miles — continue to 2700 South, then east about a mile to Crystal Ave and turn right.' }
        ],
      ...
      'kearns': {
        ...
        landmarks: [
          { name: 'Utah Olympic Oval — 5662 Cougar Lane', distance: '2 miles east of central Kearns', tip: 'A recognizable Kearns landmark near the 5400 South route east to our shop. The surrounding residential grid is the short-trip driving pattern that produces Kearns\' most common check engine codes — misfires and EGR fouling from cold engines that never fully warm up.' },
          { name: '5400 South & Redwood Road', distance: '4 min west of shop', tip: 'The heart of Kearns\' stop-and-go commercial corridor. The sustained low-speed loads here keep the catalytic converter below its self-cleaning temperature on short trips — a primary factor in the P0420 and misfire codes we see most from Kearns vehicles.' },
          { name: '5400 South & State Street', distance: '3 min from shop', tip: 'The main junction coming east from Kearns. Turn north on State Street from 5400 South and continue 1.5 miles — Crystal Ave is on the left. We\'re halfway down the block at 144 W Crystal Ave.' }
        ],
      ...
      'midvale': {
        ...
        landmarks: [
          { name: 'Midvale Center TRAX Station — 7200 S State Street', distance: '5 miles south of shop', tip: 'The most convenient Blue Line stop for Midvale customers whose vehicle can\'t be safely driven. Board here heading north and ride to Central Pointe Station — a 3-minute walk to our shop. Free towing covers repairs over $1,000 if you can\'t drive at all.' },
          { name: 'I-15/I-215 Interchange — 7200 South', distance: '4 miles south of shop', tip: 'The interchange thermal cycling zone — high-speed merge accelerations followed by abrupt stops on the ramp exits are the most common O2 sensor stress pattern for Midvale daily commuters. Vehicles in this pattern accumulate O2 sensor wear faster than freeway-only drivers.' },
          { name: '7200 South & State Street', distance: '4 miles south of shop', tip: 'The main Midvale commercial intersection. Head north on State Street from here — it\'s a straight 4-mile shot to Crystal Ave on the left, just past the 2700 South light. We\'re at 144 W Crystal Ave.' }
        ],
  ...
  'transmission-repair': {
    ...
    cities: {
      'sugar-house': {
        ...
        landmarks: [
          { name: '1300 East Downhill Grade — Hill-Start Torque Zone', distance: '2 min north of shop', tip: 'The steep descent from the Sugar House business district toward South Salt Lake where repeated hill-start torque demands and engine-braking cycles put daily ATF stress. Transmission hesitation on this grade in cold weather is an early warning sign that degraded ATF is affecting clutch pack response.' },
          { name: 'Central Pointe TRAX Station — 900 W / 2100 S', distance: '0.3 miles from shop', tip: 'The nearest TRAX stop if your transmission has failed and the vehicle can\'t be driven. Walk 3 minutes east to our shop at 144 W Crystal Ave — or call us first if you\'re unsure whether the car is safe to move at all.' },
          { name: 'Sugarmont Drive & 1100 East', distance: '3 min northeast of shop', tip: 'The steepest Sugar House residential grade, where hill-start torque demands on automatic transmissions are highest. A transmission that holds in drive on flat streets but slips on this grade has an internal problem worth diagnosing before it gets worse.' }
        ],
      ...
      'millcreek': {
        ...
        landmarks: [
          { name: 'Millcreek Canyon Switchbacks — Transfer Case Test Route', distance: '5 min east of shop', tip: 'The Millcreek Canyon road switchbacks are where transfer case and 4WD actuator failures become obvious — engaging 4WD on a slick or steep switchback requires a system that actually delivers. A transfer case that tests fine in the driveway but fails on the first steep canyon corner is a common pattern from this area.' },
          { name: 'Wheeler Historic Farm — 6351 S 900 E', distance: '3 min south of canyon route', tip: 'A recognizable Millcreek landmark near the 3300 South corridor. From Wheeler Farm, head west on 3300 South to Highland Drive, then north — our shop is about 3 miles ahead on Crystal Ave.' },
          { name: '3300 South & State Street', distance: '0.5 miles east of shop', tip: 'The main Millcreek junction on the State Street route to our shop. From 3300 South & State Street, head north on State Street — Crystal Ave is a few blocks ahead on the left at 144 W Crystal Ave.' }
        ],
      ...
      'murray': {
        ...
        landmarks: [
          { name: 'State Street & 5400 South — Peak Stop-and-Go Zone', distance: '2 miles south of shop', tip: 'The highest-density stop-and-go section of the Murray State Street corridor, where repeated park-to-drive cycles at elevated ATF temperature are hardest on solenoids and clutch pack friction material. High-mileage Murray transmissions see more solenoid wear from this corridor than from any other single driving pattern.' },
          { name: 'Murray Central TRAX Station — Red Line', distance: '4 miles south of shop', tip: 'The main Red Line transit option for Murray customers whose transmission has failed. Board here heading north — Central Pointe is one stop, then a 3-minute walk to our shop. Call ahead if you\'re unsure whether the car is safe to drive at all.' },
          { name: 'Fashion Place Mall — 6191 S State Street', distance: '4 miles south on State St', tip: 'A clear Murray landmark on the State Street route to our shop. From Fashion Place heading north, it\'s a straight 3.5-mile drive to Crystal Ave on the left — we\'re halfway down the block at 144 W Crystal Ave.' }
        ],
      ...
      'salt-lake-city': {
        ...
        landmarks: [
          { name: 'Virginia Street Hill — Avenues Daily Transmission Grade', distance: '4 min northeast of shop', tip: 'The steepest residential grade in the Avenues and one of the most demanding daily transmission environments in the city. A transmission that slips, hesitates, or rolls back slightly before engaging on Virginia Street is showing an internal problem that flat-ground driving doesn\'t reveal — and grade testing is the fastest diagnostic shortcut.' },
          { name: 'State Street & I-80 Overpass', distance: '1 mile north of shop', tip: 'A clear route marker heading south from downtown SLC. Once you cross under I-80 on State Street, our shop is 1 mile ahead — stay on State Street and turn right on Crystal Ave, halfway down the block at 144 W Crystal Ave.' },
          { name: 'Central Pointe TRAX Station — 900 W / 2100 S', distance: '0.3 miles from shop', tip: 'The closest TRAX stop to our shop — both Red and Blue Lines stop here. If your SLC vehicle can\'t be safely driven due to a transmission failure, board TRAX and walk 3 minutes east from Central Pointe to our shop.' }
        ],
      ...
      'taylorsville': {
        ...
        landmarks: [
          { name: 'I-215 On-Ramp at 4700 South — Full-Throttle Upshift Zone', distance: '4 min west of shop', tip: 'The main I-215 on-ramp from Taylorsville where full-throttle ramp acceleration demands rapid upshifts through multiple gears. This sequence cycles torque converter lockup clutches more intensively than any stop-and-go pattern — and it compounds the ATF thermal load already created by Taylorsville\'s suburban stop-and-go driving.' },
          { name: 'Meadowbrook TRAX Station — Red Line', distance: '5 min northwest of shop', tip: 'A transit option for Taylorsville customers whose vehicle can\'t be driven safely. Board the Red Line here and ride north to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: '4700 South & State Street', distance: '3 min from shop', tip: 'The main junction coming from Taylorsville. Turn north on State Street from 4700 South — Crystal Ave is about 2 miles ahead on the right. Our shop is at 144 W Crystal Ave.' }
        ],
      ...
      'west-valley-city': {
        ...
        landmarks: [
          { name: '3500 South Commercial Corridor — Redwood Road to State Street', distance: '4 min west of shop', tip: 'The main West Valley City commercial strip where sustained low-speed stop-and-go keeps transmissions cycling at elevated temperatures throughout the day. USANA Amphitheatre event congestion on this corridor creates sudden high-density stop-and-go that forces repeated downshift-upshift sequences at temperatures already elevated from the commercial traffic baseline.' },
          { name: 'West Valley Central TRAX Station — Red Line', distance: '5 min west of shop', tip: 'The nearest Red Line station for West Valley City customers whose vehicle can\'t be driven safely. Board here heading east — ride to Central Pointe Station, then a 3-minute walk east to our shop at 144 W Crystal Ave.' },
          { name: 'I-215 & 3500 South Interchange — West Valley Entry', distance: '4 min east of shop', tip: 'The main freeway junction for West Valley City to our shop. Head east on I-215 from the 3500 South interchange — take the 2100 South exit, head east, and turn right on Crystal Ave.' }
        ],
      ...
      'holladay': {
        ...
        landmarks: [
          { name: 'Big Cottonwood Canyon Approach — Wasatch Blvd traction gate', distance: '6 min east', tip: 'The canyon traction checkpoint for Holladay ski vehicles. A 4WD or AWD system that hasn\'t been tested since the previous season may fail to engage here — the actuator that worked fine in October can stick after a summer of disuse. A pre-season transfer case test and fluid check prevents the gate surprise.' },
          { name: 'Fort Union Boulevard & Highland Drive', distance: '4 min from shop', tip: 'The main Holladay arterial connecting south to Highland Drive north. Head north from Fort Union on Highland Drive — our shop is about 4 minutes ahead on Crystal Ave, the left turn just before 2100 South.' },
          { name: '4500 South & Highland Drive', distance: '4 min from shop', tip: 'The main Holladay landmark on the Highland Drive route north to our shop. Continue north on Highland Drive from here through Sugar House — Crystal Ave is the left turn about 4 miles ahead.' }
        ],
      ...
      'cottonwood-heights': {
        ...
        landmarks: [
          { name: 'Little Cottonwood Canyon Entrance — 9000 S Wasatch Blvd', distance: '5 min east', tip: 'The traction restriction checkpoint that makes 4WD and AWD reliability a practical necessity for Cottonwood Heights ski vehicles. Transfer case actuators and encoder motors that fail at this gate are the most common transmission-related repair we see from this city — all of which are preventable with a pre-season service and test.' },
          { name: 'Big Cottonwood Canyon Rd & Wasatch Blvd', distance: '4 min east', tip: 'The second canyon corridor for Cottonwood Heights vehicles — also subject to traction restrictions and sustained high-torque grade climbing with loaded ski vehicles. The same transfer case system must handle both canyons reliably.' },
          { name: 'Fort Union Blvd & Highland Drive', distance: '4 min from shop', tip: 'The main turn heading north toward our shop from Cottonwood Heights. Take Highland Drive north from Fort Union through Holladay and Sugar House — Crystal Ave is about 4 miles ahead on the left.' }
        ],
      ...
      'sandy': {
        ...
        landmarks: [
          { name: 'Little Cottonwood Canyon Road — Sandy\'s Canyon Staging Route', distance: '10 min east', tip: 'The canyon approach that Sandy ski vehicles most commonly use. The sustained high-torque grade climbing here — loaded with ski gear and passengers — puts the same transmission and transfer case demands on Sandy vehicles that Snowbird and Alta regulars eventually notice as delayed engagement or shudder on cold starts.' },
          { name: 'Sandy Civic Center TRAX Station — Blue Line', distance: '8 miles south of shop', tip: 'The most convenient Blue Line station for Sandy customers whose transmission has failed and the vehicle can\'t be driven safely. Board here heading north and ride to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: '10600 South & I-15 Interchange', distance: '6 miles south of shop', tip: 'The main Sandy freeway entry heading north to our shop. Take I-15 north from 10600 South — 6 miles to the 2700 South exit in South Salt Lake, then east about a mile to Crystal Ave.' }
        ],
      ...
      'draper': {
        ...
        landmarks: [
          { name: 'Point of the Mountain — I-15 Grade at the SL/Utah County Line', distance: '9 miles south of shop', tip: 'The steepest sustained I-15 grade in the valley — where Draper transmissions encounter their most demanding daily condition. Each southbound descent requires sustained engine braking and each northbound climb requires full-load upshifts, creating a thermal stress cycle that shortens ATF life faster than any flat-terrain commute.' },
          { name: 'SunCrest Drive Entry — Upper Draper Towing Route', distance: '8 min southeast', tip: 'The winding hillside access road into SunCrest where Draper\'s outdoor recreation vehicles begin tow runs toward Jordanelle or the Uintas. The grade combined with trailer tongue weight creates one of the highest torque converter lockup clutch stress conditions in the south valley.' },
          { name: 'Draper Town Center TRAX Station — Blue Line', distance: '12 miles south of shop', tip: 'The most convenient Blue Line station for Draper customers whose vehicle can\'t be driven safely. Board here heading north and ride to Central Pointe Station — 3 minutes from our shop at 144 W Crystal Ave.' }
        ],
      ...
      'west-jordan': {
        ...
        localContent: 'Mountain View Corridor\'s high posted speeds require aggressive upshifts and hard downshifts that cycle the transmission more intensively than residential driving. West Jordan has a high proportion of trucks and SUVs used for hauling and weekend towing — to Oquirrh Mountain OHV trails, to job sites, and to the Wasatch resorts. Vehicles doing regular towing without ATF services build up sludge in the valve body that eventually causes delayed engagement, erratic shifts, and solenoid failure.',
        ...
        landmarks: [
          { name: 'Oquirrh Mountain OHV Staging — near 8000 S Bacchus Hwy', distance: '7 min west', tip: 'The primary OHV staging area from West Jordan where truck and SUV towing and hauling to Oquirrh Mountain trails is common. Trail towing on loose terrain with a loaded trailer puts higher torque converter and transfer case demands on West Jordan vehicles than freeway towing — ATF condition matters more here than mileage alone suggests.' },
          { name: 'Mountain View Corridor & 7800 South — High-Speed Shift Zone', distance: '5 miles south of shop', tip: 'The main West Jordan segment of Mountain View Corridor where high posted speeds force rapid upshifts and hard downshifts. The combined thermal load of this corridor with weekend towing is the most common transmission stress pattern from West Jordan vehicles — and the most predictable cause of solenoid failure when ATF is overdue.' },
          { name: '5400 South & State Street', distance: '3 miles south of shop', tip: 'An alternate route from West Jordan. Turn north on State Street from 5400 South and continue about 2.5 miles — Crystal Ave will be on your left at 144 W Crystal Ave.' }
        ],
      ...
      'south-jordan': {
        ...
        landmarks: [
          { name: 'Daybreak Parkway Roundabout Corridor — Low-Speed Cycle Zone', distance: '10 min south', tip: 'Daybreak\'s roundabout-heavy grid creates more low-speed torque demand cycles per commute than any grid-street neighborhood in the valley. Each roundabout exit acceleration is a brief ATF heat event — thousands of these over several years accumulate the TCC solenoid wear that shows up as shudder from exactly this speed range.' },
          { name: 'Daybreak Pkwy TRAX Station — Blue Line', distance: '10 miles south of shop', tip: 'The Blue Line station for Daybreak customers whose transmission has failed or the vehicle can\'t be safely driven. Board here heading north and ride to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: 'Bangerter Highway & I-15 Interchange', distance: '8 miles south of shop', tip: 'The main freeway junction for most South Jordan drivers heading to our shop. Head north on I-15 — about 8 miles to the 2700 South exit in South Salt Lake, then east about a mile to Crystal Ave.' }
        ],
      ...
      'riverton': {
        ...
        landmarks: [
          { name: 'Jordan Narrows OHV Area — SR-68 South of Riverton', distance: '10 min south', tip: 'The main off-road towing and access corridor for Riverton trucks heading to Jordan Narrows wash crossings. Rocky approach roads and seasonal wash crossings here put higher torque demands on transfer cases than pavement towing — transfer case fluid condition matters more on these runs than mileage alone would suggest.' },
          { name: 'Bangerter Highway & Mountain View Corridor Junction', distance: '10 miles south of shop', tip: 'The key starting point for the freeway leg north to our shop from Riverton. Head east on Bangerter to I-15, then north on I-15 for about 8 miles to the 2700 South exit in South Salt Lake.' },
          { name: '2700 South Exit off I-15 — South Salt Lake', distance: '1 mile from shop', tip: 'The turn-off for our shop coming north from Riverton on I-15. Head east from the exit and turn right on Crystal Ave — our shop is at 144 W Crystal Ave on the left side of the block.' }
        ],
      ...
      'herriman': {
        ...
        landmarks: [
          { name: 'Herriman Hills Residential Grade — 13200 South Area', distance: '15 min south', tip: 'The steepest section of Herriman\'s hillside residential streets, where daily hill-start torque demands at low vehicle speed are the most thermally stressful shift condition for an automatic transmission. A transmission that hunts between gears climbing toward Herriman neighborhoods has a problem that will worsen before it self-corrects.' },
          { name: 'Mountain View Corridor North Entry — Herriman', distance: '15 miles south of shop', tip: 'The beginning of the high-speed commute segment where Mountain View Corridor and I-15 carry Herriman vehicles north. Sustained freeway loads on top of daily hill-start cycling compound ATF degradation faster than either driving pattern alone.' },
          { name: '5400 South Interchange off I-15', distance: '5 miles south of shop', tip: 'A useful midpoint landmark on the I-15 run north from Herriman. From here, our exit is 3 more miles — continue to 2700 South, then east about a mile to Crystal Ave and turn right.' }
        ],
      ...
      'kearns': {
        ...
        landmarks: [
          { name: 'SR-201 & Bacchus Highway Interchange — Kearns Towing Corridor', distance: '5 min west', tip: 'The Kearns access point to SR-201 and Bacchus Highway westbound toward Tooele County. Kearns trucks and SUVs doing weekend towing to the Oquirrh Mountain OHV areas or Tooele destinations via this corridor add the towing heat cycles that compound ATF degradation already present from high daily mileage.' },
          { name: 'Utah Olympic Oval — 5662 Cougar Lane', distance: '2 miles east of central Kearns', tip: 'A well-known Kearns landmark near the 5400 South route east to our shop. From the Oval, continue east on 5400 South to State Street, then north 1.5 miles to Crystal Ave — our shop is halfway down the block on the left.' },
          { name: '5400 South & State Street', distance: '3 min from shop', tip: 'The main junction coming east from Kearns to our shop. Turn north on State Street from 5400 South and continue 1.5 miles — Crystal Ave is on the left. We\'re halfway down the block at 144 W Crystal Ave.' }
        ],
      ...
      'midvale': {
        ...
        landmarks: [
          { name: 'I-15/I-215 Interchange — 7200 South Shift Cycling Zone', distance: '4 miles south of shop', tip: 'The most transmission-intensive commute zone for Midvale drivers — high-speed freeway merges followed by abrupt stop-and-go cycling within the same commute alternates between lockup-clutch engagement and low-speed shift sequences at elevated temperature. This pattern degrades ATF faster than pure freeway or pure stop-and-go driving alone.' },
          { name: 'Midvale Center TRAX Station — Blue Line', distance: '5 miles south of shop', tip: 'The most convenient Blue Line stop for Midvale customers whose transmission has failed and the vehicle can\'t be driven. Board here heading north and ride to Central Pointe Station — 3 minutes east on foot to our shop at 144 W Crystal Ave.' },
          { name: '7200 South & State Street', distance: '4 miles south of shop', tip: 'The main Midvale commercial intersection on State Street. Head north from here for about 4 miles — Crystal Ave will be on your left just past the 2700 South light at 144 W Crystal Ave.' }
        ],
...
Object.entries(CONTENT).forEach(([serviceKey, svc]) => {
  ...
  CITIES.forEach(city => {
    ...
    serviceGeoPages.push({
      ...
      landmarks: c.landmarks || city.landmarks || null,
