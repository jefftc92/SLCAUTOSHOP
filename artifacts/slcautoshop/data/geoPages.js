const geoPages = [
  {
    ...
    localContent: "Sugar House's hills, the I-80 on-ramp at 1300 East, the grades on Harrison and Kensington Avenues, put more wear on a clutch than flat-city driving. When something starts feeling off, it can be hard to tell what actually needs to be fixed. A lot of Sugar House drivers have already had work done somewhere else before coming to us, because the first shop replaced a part without figuring out what caused the problem. We check everything first.",
    shortDefinition: "A clutch connects your engine to your transmission so you can change gears. It has several components, and when any of them wear out, you'll feel it as slipping, difficulty shifting, or a pedal that feels different than it used to. Our service page covers what we check and how we diagnose each issue.",
    ...
    processNote: "For Sugar House customers, most clutch jobs are completed the same day, drop off at 9 AM and pick up before close.",
    whyChooseUs: [
      { title: "5 Minutes from Sugar House", desc: "Highland Drive to Crystal Ave, one turn, no freeway. Drop off at 9 AM, Lyft back to the neighborhood, and pick up the same day. No reason to cross the valley for clutch work." },
      { title: "We Know What Sugar House Terrain Does to Clutches", desc: "We diagnose clutches from these hills every week. The I-80 on-ramp load, the Harrison Avenue hill starts, we've seen these wear patterns for 36 years and know exactly what to look for first." },
      { title: "Diagnosis Before We Recommend Anything", desc: "Before we suggest a disc replacement, we check the hydraulic system. Hill-start slipping is often a cylinder issue, not a worn disc. We tell you the truth and only replace what the car actually needs." },
      { title: "Specialists Since 1990", desc: "Clutch repair is all we've done since 1990, it's literally in the name. Sugar House drivers come here because general shops send them back with the same problem. We fix it right the first time." }
    ]
  },
  {
    ...
    directions: "Take 3300 South west from Millcreek toward South Salt Lake. Turn right on Highland Drive (1300 East) and head north briefly, then turn left on Crystal Ave. Our shop is on the right. No freeway required, it's an easy 7-minute surface road trip from most parts of Millcreek.",
    processNote: "For Millcreek customers, canyon-driving jobs sometimes need an extra day depending on parts. We'll give you an honest timeline when you call, and most jobs are done same-day.",
    landmarks: [
  ...
  },
  {
    ...
    intro: "Murray's central valley location and State Street traffic make it a stop-and-go clutch workout. Scott's Auto & Clutch Repair is just 4 miles north, 8 minutes on State Street. We've been the trusted clutch repair shop for Murray drivers since 1990.",
    localContent: "State Street through Murray is stop-and-go a lot of the time, and a manual transmission driver is working the clutch constantly through that traffic. The Fashion Place area can be especially slow, sitting in heavy traffic in gear wears things out faster than most people realize. Murray drivers usually come in saying the clutch doesn't feel the way it used to. We check the whole system before recommending anything.",
    shortDefinition: "A clutch connects your engine to your transmission so you can change gears. It has several components, and when any of them wear out, you'll feel it as slipping, difficulty shifting, or a pedal that feels different than it used to. Our service page covers what we check and how we diagnose each issue.",
    ...
    directions: "Head north on State Street from Murray. Stay on State Street through the Murray–South Salt Lake border and turn left on Crystal Ave, it's about 0.25 miles north of the 2700 South light. We're half a mile west of State Street on the right side. Murray TRAX riders can use the Murray Central or Meadowbrook stations and take a quick rideshare to our door.",
    logisticsNote: "Murray Central TRAX Station is the most convenient transit option for Murray customers. Board the Red Line at Murray Central, ride one stop north to Central Pointe Station, and walk 3 minutes east on 2100 South to our shop at 144 W Crystal Ave. Drop your car in the morning, take TRAX to work or wherever you need to be, and we'll call when the job is done. Uber and Lyft are also available from our lot throughout the day, the ride from our shop back to Fashion Place or Murray Central takes about 8 minutes.",
  ...
  },
  {
    ...
    localContent: "Salt Lake City covers a lot of different driving depending on where you live and work. Avenues residents deal with some of the steepest streets in the valley, starting on a hill every morning is harder on a clutch than most types of driving. Downtown commuters face a different issue: the one-way grid means a lot of constant shifting through tight traffic. University of Utah students with older manuals are some of our most regular customers.",
    shortDefinition: "The clutch on a manual car is what connects your engine to the wheels when you shift. It's made up of several parts, and any one of them can wear over time. The most common signs are slipping, grinding when shifting, or a pedal that requires more effort than it used to. See our service page for how we diagnose it.",
    ...
    directions: "Head south on State Street from downtown Salt Lake City. Cross over I-80 and continue into South Salt Lake, Crystal Ave is about 1 mile south of I-80. Turn right and we're on the left side of the street. TRAX riders can take the Red or Blue Line to Central Pointe station (900 West / 2100 South) and walk 10 minutes east or take a short rideshare straight to our door.",
    logisticsNote: "TRAX makes this the easiest commute for any Salt Lake City customer. Take the Red or Blue Line to Central Pointe Station and walk 3 minutes east to our shop at 144 W Crystal Ave, no rideshare needed. Drop your car at 9 AM, ride TRAX back to downtown, the Avenues, or the U, and we'll call when the diagnosis is done. Driving? Take State Street south from downtown, cross under I-80, and Crystal Ave is the second major left, about 1 mile past the freeway. Uber and Lyft are available from our location throughout business hours for the return trip.",
    processNote: "Salt Lake City customers can drop off early and take TRAX or a rideshare back. Most clutch jobs are done same-day. Call ahead so we can let you know about your specific vehicle.",
    landmarks: [
  ...
  },
  {
    ...
    localContent: "Taylorsville's major roads, 4700 South, Redwood Road, 5400 South, move fast between the lights, but the signals still stop traffic often. The I-215 on-ramps in Taylorsville are short, which means getting up to speed quickly every time you merge. That kind of driving wears a clutch faster than a longer, steadier commute. When Taylorsville drivers start noticing something off, it usually means it's been building for a while.",
    shortDefinition: "A clutch connects your engine to your transmission so you can change gears. It has several components, and when any of them wear out, you'll feel it as slipping, difficulty shifting, or a pedal that feels different than it used to. Our service page covers what we check and how we diagnose each issue.",
    ...
    whyChooseUs: [
      { title: "10 Minutes on 4700 South", desc: "4700 South east to State Street, then north, one turn and 10 minutes from most of Taylorsville. Drop off at 9 AM and most jobs are done before the end of the day." },
  ...
  },
  {
    ...
    intro: "West Valley City is the second-largest city in Utah, and its busy roads create constant clutch demand. We're 7 miles east, about 12 minutes on 3500 South. Scott's Auto & Clutch Repair has been the affordable clutch specialist for West Valley drivers since 1990.",
    localContent: "3500 South is one of the busiest roads in the state, and driving it in a manual means stopping and going through a lot of signals every day. Event nights near the USANA Amphitheatre make it worse, slow bumper-to-bumper traffic while managing a clutch in the heat is tough on the car. West Valley drivers sometimes notice a burning smell after a slow evening drive. Usually that means something needs attention.",
    shortDefinition: "The clutch on a manual car is what connects your engine to the wheels when you shift. It's made up of several parts, and any one of them can wear over time. The most common signs are slipping, grinding when shifting, or a pedal that requires more effort than it used to. See our service page for how we diagnose it.",
    ...
    directions: "Take 3500 South east across Redwood Road and continue to State Street. Turn left (north) briefly on State Street, then left again on Crystal Ave. Our shop is half a mile down on the right. Alternatively, take I-215 south to I-15 south, exit at 2100 South, and head east to the Highland Drive area, then south to Crystal Ave. Most West Valley routes put you at our door in 12 minutes in normal traffic.",
  ...
  },
  {
    ...
    localContent: "Holladay sits at the mouth of Big Cottonwood Canyon, and if you use the canyon regularly, your clutch works harder than typical valley driving. Climbing a steep mountain road in slow traffic is hard on the car. Coming back down and using the engine to control speed adds heat. The combination of canyon and valley driving means Holladay customers sometimes need clutch work sooner than they'd expect, we see this pattern regularly.",
    shortDefinition: "On a manual transmission, the clutch is what lets you shift gears, it connects and disconnects your engine from the drivetrain every time you press the pedal. When parts wear out, you'll notice slipping under power, trouble getting into gear, or a pedal that feels off. The full diagnostic process is explained on our service page.",
  ...
  },
  {
    ...
    localContent: "Sandy's eastern neighborhoods near Bell Canyon and Dimple Dell have some steep residential streets, and starting on a hill every day adds up over time. Sandy I-15 commuters also deal with a lot of stop-and-go between 10600 South and downtown. Put those two things together and you've got a clutch that works hard from both ends of the commute. Sandy drivers usually come in because something feels different, the pedal, the engagement, the sound. We check everything before pointing to any specific part.",
    shortDefinition: "On a manual transmission, the clutch is what lets you shift gears, it connects and disconnects your engine from the drivetrain every time you press the pedal. When parts wear out, you'll notice slipping under power, trouble getting into gear, or a pedal that feels off. The full diagnostic process is explained on our service page.",
  ...
  },
  {
    ...
    processNote: "Draper customers making the 15-minute drive can drop off at 9 AM. Most clutch jobs are done by afternoon. Call ahead so we can give you an accurate time estimate.",
    landmarks: [
    ...
    whyChooseUs: [
      { title: "Worth the 15-Minute Drive", desc: "Draper drivers make the I-15 trip because the closer options haven't solved the problem. Drop off at 9 AM and most clutch jobs are done by afternoon. TRAX Blue Line to Central Pointe is also an option." },
  ...
  },
  {
    ...
    localContent: "West Jordan is a large city with a lot of driving between neighborhoods, schools, and work. The 7800 South commercial area means constant stopping and starting. Mountain View Corridor is fast but the exits require quick slowdowns, going from highway speed to a stop in a manual takes a toll over time. West Jordan drivers usually first notice the clutch feels a little different, or takes a little more effort. That's usually the right time to get it checked.",
    shortDefinition: "The clutch on a manual car is what connects your engine to the wheels when you shift. It's made up of several parts, and any one of them can wear over time. The most common signs are slipping, grinding when shifting, or a pedal that requires more effort than it used to. See our service page for how we diagnose it.",
    ...
    directions: "Take Redwood Road north to the UT-201 connector, then east to I-15 north. Exit at 2700 South in South Salt Lake and head east, Crystal Ave is about a mile east of the freeway. Alternatively, take 5400 South east to State Street, then turn north on State Street and left on Crystal Ave. Both routes take about 12 minutes from central West Jordan in light traffic.",
  ...
  },
  {
    ...
    localContent: "South Jordan and Daybreak are quiet neighborhoods with a lot of roundabouts, easy on brakes, but the constant low-speed shifting in a manual adds up over time. Bangerter Highway is faster, but the ramp transitions can be abrupt. Add in a long commute for most South Jordan residents, and a clutch gets a lot of use every day. Most customers come in saying it's been slipping or the pedal doesn't feel right. We check the whole system and tell you exactly what we find.",
    shortDefinition: "A clutch connects your engine to your transmission so you can change gears. It has several components, and when any of them wear out, you'll feel it as slipping, difficulty shifting, or a pedal that feels different than it used to. Our service page covers what we check and how we diagnose each issue.",
    ...
    directions: "Take I-15 north from South Jordan approximately 10 miles and exit at 2700 South in South Salt Lake. Head east and turn right on Crystal Ave. Our shop is on the left side. Daybreak TRAX riders can board at Daybreak Parkway station and ride north on the Blue Line to Central Pointe station, then walk 10 minutes east or take a short rideshare to 144 W Crystal Ave. Most South Jordan customers arrive in about 14 minutes by freeway.",
    processNote: "South Jordan customers can drop off and ride TRAX to work from Daybreak. Most clutch jobs are done same day. Call ahead to confirm.",
    landmarks: [
  ...
  },
  {
    ...
    directions: "Take Bangerter Highway east from Riverton to I-15 north. Head north on I-15 approximately 8 miles and exit at 2700 South in South Salt Lake. Turn east and find Crystal Ave on the right. Our shop is on the left side. The drive is mostly freeway and takes about 16 minutes in moderate traffic. Many Riverton customers drop off first thing at 9 AM and arrange a same-day pickup, call ahead and we'll confirm whether your job qualifies.",
    ...
    whyChooseUs: [
      { title: "Worth the 16-Minute Drive", desc: "Riverton doesn't have a clutch specialist nearby, that's why drivers make the freeway trip. Drop off at 9 AM on the way out and pick up the same day. Call ahead to confirm timing." },
  ...
  },
  {
    ...
    intro: "Herriman is the fastest-growing city in the southwest valley, and there are almost no clutch specialists nearby. That's why Herriman drivers make the 20-minute drive to Scott's Auto & Clutch Repair. We've been doing clutch work since 1990, before most of Herriman's neighborhoods existed.",
    localContent: "Herriman's hillside neighborhoods at the base of the Oquirrh Mountains have some steep streets, and starting on a hill every day wears a clutch faster than flat driving. The commute from Herriman to most valley employers is also one of the longer ones in the area, adding mileage on top of the hill-start wear. There aren't many clutch specialists close to Herriman, which is why drivers make the trip to Scott's, for work that actually gets to the root of the problem.",
    shortDefinition: "A clutch is what makes gear changes possible on a manual transmission, press the pedal to cut the connection between engine and wheels, shift, release to reconnect. When something in that system wears out, you'll feel it as slipping, grinding, or a pedal that doesn't feel right. Our service page walks through what we inspect and how we find the problem.",
    ...
    whyChooseUs: [
      { title: "No Closer Clutch Specialist", desc: "Herriman doesn't have a dedicated clutch specialist, the 20-minute drive to Scott's is the closest real option. Drop off at 9 AM and most jobs are done the same day." },
  ...
  },
  {
    ...
    localContent: "Kearns is a working community where vehicles get used hard every day. The 4500 South on-ramp to I-15 is short, getting up to speed quickly from a stop every morning is the kind of thing that wears a clutch faster than most people expect. Kearns drivers usually come in when the clutch starts slipping or the pedal feels different. We don't recommend more than what the car needs, that matters when you depend on your car every day.",
    shortDefinition: "On a manual transmission, the clutch is what lets you shift gears, it connects and disconnects your engine from the drivetrain every time you press the pedal. When parts wear out, you'll notice slipping under power, trouble getting into gear, or a pedal that feels off. The full diagnostic process is explained on our service page.",
    ...
    directions: "Take 5400 South east from Kearns to State Street. Turn left (north) on State Street and head about 1.5 miles into South Salt Lake. Turn left on Crystal Ave, we're half a mile west of State Street on the right side. About 12 minutes from central Kearns in normal traffic. If you prefer a freeway route, take 4700 South east to I-15 north, exit at 2700 South, and head east to Crystal Ave.",
    processNote: "Kearns customers are about 12 minutes away, drop off in the morning and most clutch jobs are done by afternoon.",
    landmarks: [
  ...
  },
  {
    ...
    localContent: "Midvale is close to us, and a lot of Midvale drivers stop in for a quick diagnosis before committing to anything. The I-15/I-215 interchange is one of the busier merge points in the valley, getting up to speed quickly from a near-stop every day adds wear faster than highway cruising. The 7200 South corridor keeps things stop-and-go for local trips. When Midvale customers notice something feels off, it usually hasn't been building long, which makes it easier and cheaper to fix.",
    shortDefinition: "The clutch on a manual car is what connects your engine to the wheels when you shift. It's made up of several parts, and any one of them can wear over time. The most common signs are slipping, grinding when shifting, or a pedal that requires more effort than it used to. See our service page for how we diagnose it.",
    ...
    directions: "Head north on State Street from Midvale, it's a straight 5-mile shot into South Salt Lake with no turns required until you reach Crystal Ave on your left. Turn left on Crystal Ave and our shop is on the right. About 8 minutes in light traffic. TRAX riders can board the Blue Line at Midvale Center or Fashion Place/Murray stations and ride to Central Pointe station, then walk 3 minutes east, we're the closest clutch specialist to any TRAX station in the valley.",
    processNote: "Midvale customers are 8 minutes away, the closest TRAX-accessible clutch specialist in the valley. Most jobs are done same day.",
    landmarks: [
...
const geoMetaMap = {
  'clutch-repair-near-sugar-house-ut':        { t: "Clutch Repair Sugar House UT | Scott's Auto & Clutch Repair",        d: "Sugar House drivers have trusted us with manual transmissions for decades. Three miles south of the neighborhood with a 5-minute drive. (801) 485-4089." },
  'clutch-repair-near-millcreek-ut':          { t: "Clutch Repair Millcreek UT | Scott's Auto & Clutch Repair",          d: "Serving Millcreek clutch work for over 35 years, including the AWD and Subaru drivers who make up a big share of the neighborhood. Call (801) 485-4089." },
  'clutch-repair-near-murray-ut':             { t: "Clutch Repair Murray UT | Scott's Auto & Clutch Repair",             d: "Murray customers appreciate being 4 miles from a clutch specialist and a 3-minute walk from TRAX when they drop off. Free diagnosis. (801) 485-4089." },
  'clutch-repair-near-salt-lake-city-ut':     { t: "Clutch Repair Salt Lake City UT | Scott's Auto & Clutch Repair",    d: "From the Avenues to downtown, SLC drivers bring their manual transmissions here. Decades of experience with hill-start and canyon clutch wear. (801) 485-4089." },
  'clutch-repair-near-taylorsville-ut':       { t: "Clutch Repair Taylorsville UT | Scott's Auto & Clutch Repair",      d: "Taylorsville families, commuters, and work-truck drivers rely on us for clutch diagnosis and replacement. Five miles east via 4700 South. (801) 485-4089." },
  'clutch-repair-near-west-valley-city-ut':   { t: "Clutch Repair West Valley City UT | Scott's Auto & Clutch Repair",  d: "West Valley commercial vehicles and commuters count on quick turnaround for clutch work. Seven miles east via I-215 or 3500 South. (801) 485-4089." },
  'clutch-repair-near-holladay-ut':           { t: "Clutch Repair Holladay UT | Scott's Auto & Clutch Repair",           d: "Canyon-driving Holladay residents know what mountain roads do to a clutch. Five miles from the neighborhood. Free diagnosis, honest assessment. (801) 485-4089." },
  'clutch-repair-near-cottonwood-heights-ut': { t: "Clutch Repair Cottonwood Heights UT | Scott's Auto & Clutch Repair", d: "Cottonwood Heights ski-season commuters put clutches through a lot. Six miles north with experienced diagnosis and straightforward quotes. (801) 485-4089." },
  'clutch-repair-near-sandy-ut':              { t: "Clutch Repair Sandy UT | Scott's Auto & Clutch Repair",              d: "Sandy I-15 commuters drop off before work and pick up after. TRAX at Central Pointe makes the logistics easy. Eight miles north. Call (801) 485-4089." },
  'clutch-repair-near-draper-ut':             { t: "Clutch Repair Draper UT | Scott's Auto & Clutch Repair",             d: "Draper customers make the 12-mile I-15 drive for careful clutch work on manual performance cars, daily drivers, and trucks alike. (801) 485-4089." },
  'clutch-repair-near-west-jordan-ut':        { t: "Clutch Repair West Jordan UT | Scott's Auto & Clutch Repair",        d: "West Jordan families bring their manuals to a shop that explains what it found before the work starts. Eight miles east. Call (801) 485-4089." },
  'clutch-repair-near-south-jordan-ut':       { t: "Clutch Repair South Jordan UT | Scott's Auto & Clutch Repair",       d: "South Jordan and Daybreak residents trust our clutch work enough to make the 10-mile drive. No upsells, just what the vehicle actually needs. (801) 485-4089." },
  'clutch-repair-near-riverton-ut':           { t: "Clutch Repair Riverton UT | Scott's Auto & Clutch Repair",           d: "Riverton drivers drop off early and pick up after work, TRAX makes the round trip practical. Twelve miles via I-15. Call (801) 485-4089." },
  'clutch-repair-near-herriman-ut':           { t: "Clutch Repair Herriman UT | Scott's Auto & Clutch Repair",           d: "Herriman truck owners, SUVs, and daily drivers make the 15-mile drive for clutch specialists who work on what they own. Call (801) 485-4089." },
  'clutch-repair-near-kearns-ut':             { t: "Clutch Repair Kearns UT | Scott's Auto & Clutch Repair",             d: "Seven miles east via 5400 South. Kearns customers appreciate the straightforward approach to clutch diagnosis and replacement. (801) 485-4089." },
  'clutch-repair-near-midvale-ut':            { t: "Clutch Repair Midvale UT | Scott's Auto & Clutch Repair",            d: "The closest clutch specialist to Midvale, five miles straight up State Street or I-15. Free diagnosis and same-day service on many jobs. (801) 485-4089." }
};

geoPages.forEach(g => {
  const gm = geoMetaMap[g.slug];
  g.metaTitle = gm ? gm.t : "Clutch Repair Near " + g.locationName + ", UT | Scott's Auto & Clutch Repair";
