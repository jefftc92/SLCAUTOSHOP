...
const brandContent = {
  ...
  'Hyundai': {
    ...
    faqs: [
      ...
      {q:'What maintenance does my Hyundai AWD system need?',a:"AWD maintenance depends on the Kia model, year, and drivetrain design. Follow the manufacturer schedule for the serviceable components and specified fluids. A coupling fault is not automatically a fluid-service problem; warning lights, leaks, noise, or binding need diagnosis."}
    ]
  },
  'Kia': {
    whatHeading: "Kia Repair and Maintenance",
    whatIntro: "Scott's Auto & Clutch Repair is a South Salt Lake shop founded in 1990. We service Kias,  Sportages, Sorentos, Tellurides, Souls, and the full Kia car and SUV lineup. We handle engine inspection and repair, direct-injection carbon cleaning, AWD drivetrain fluid service, steering and suspension work, brake service, and check engine diagnostics. Kia's presence in the Salt Lake Valley has grown significantly, and we service all of them. Every Kia gets a free diagnosis before any work is recommended, you'll know exactly what we found, what the repair costs, and why it's needed.",
    whyIntro: "We start by discussing your Kia model, mileage, symptoms, and service history. The inspection helps distinguish a needed repair from routine maintenance. If recall coverage may apply, check eligibility with Kia before authorizing paid work. We explain the findings and estimate before repairs begin.",
    whoContent: {
    ...
    intro: "Kia repair at our South Salt Lake shop, which opened in 1990. We service Tellurides, Sorentos, Sportages, Fortes, and the full Kia lineup, free diagnosis before any work starts, written estimate, and honest pricing well below dealer rates.",
    whyUs: [
    ...
    faqs: [
      ...
      {q:'What does my Kia AWD system need for maintenance?',a:"AWD maintenance depends on the Kia model, year, and drivetrain design. Follow the manufacturer schedule for the serviceable components and specified fluids. A coupling fault is not automatically a fluid-service problem; warning lights, leaks, noise, or binding need diagnosis."}
    ]
  },
  'Volkswagen': {
